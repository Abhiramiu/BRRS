...
public void updateReport(Q_SMME_DEP_Summary_Entity updatedEntity) {
    ...
    Q_SMME_DEP_Summary_Entity existingSummary =
            brrs_Q_SMME_DEP_summary_repo
    ...
    Q_SMME_DEP_Detail_Entity detailEntity =
            brrs_Q_SMME_DEP_detail_repo
                    .findById(updatedEntity.getReportDate())
                    .orElseGet(() -> {
    ...
    try {
        ...
        for (int i = 11; i <= 47; i++) {
            ...
            String[] fields = {
                    "PRODUCT", "CURRENT", "CALL", "SAVINGS",
                    "0_31D_NOTICE", "32_88D_NOTICE", "91D_DEPOSIT",
                    "1_2M_FD", "4_6M_FD", "7_12M_FD",
                    "13_18M_FD", "19_24M_FD", "OVER24_FD",
                    "TOTAL", "NOACC"
            };
            ...
            for (String field : fields) {
                ...
                try {
                    ...
                    Method getter =
                            Q_SMME_DEP_Summary_Entity.class.getMethod(getterName);

                    Object newValue = getter.invoke(updatedEntity);

                    // 🔹 Set in SUMMARY
                    Method summarySetter =
                            Q_SMME_DEP_Summary_Entity.class
                    ...
                    // 🔹 Set in DETAIL
                    Method detailSetter =
                            Q_SMME_DEP_Detail_Entity.class
                                    .getMethod(setterName, getter.getReturnType());
...
// RESUB VIEW
	...
	public byte[] getQ_SMME_DEPExcel(String filename, String reportId, String fromdate, String todate,
		...
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
			try {
				...
				return getExcelQ_SMME_DEPARCHIVAL(filename, reportId, fromdate, todate, currency, dtltype, type,
						format, version);
			} catch (ParseException e) {
...
//EMAIL
	...
	BigDecimal total =
	    (record.getR11_1_2M_FD() == null ? BigDecimal.ZERO : record.getR11_1_2M_FD())
	...
	BigDecimal total1 =
	    (record.getR12_1_2M_FD() == null ? BigDecimal.ZERO : record.getR12_1_2M_FD())
	...
	BigDecimal total7 =
	    (record.getR13_1_2M_FD() == null ? BigDecimal.ZERO : record.getR13_1_2M_FD())
	...
	BigDecimal total8 =
	    (record.getR14_1_2M_FD() == null ? BigDecimal.ZERO : record.getR14_1_2M_FD())
	...
	BigDecimal total3 =
	    (record.getR15_1_2M_FD() == null ? BigDecimal.ZERO : record.getR15_1_2M_FD())
	...
	BigDecimal total11 =
	    (record.getR16_1_2M_FD() == null ? BigDecimal.ZERO : record.getR16_1_2M_FD())
	...
	BigDecimal total81 =
	    (record.getR17_1_2M_FD() == null ? BigDecimal.ZERO : record.getR17_1_2M_FD())
	...
	BigDecimal total4 =
	    (record.getR18_1_2M_FD() == null ? BigDecimal.ZERO : record.getR18_1_2M_FD())
	...
	BigDecimal total5 =
	    (record.getR19_1_2M_FD() == null ? BigDecimal.ZERO : record.getR19_1_2M_FD())
	...
	BigDecimal totalR20 =
	    (record.getR20_1_2M_FD() == null ? BigDecimal.ZERO : record.getR20_1_2M_FD())
	...
	BigDecimal totalR21 =
	    (record.getR21_1_2M_FD() == null ? BigDecimal.ZERO : record.getR21_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR22 =
	    (record.getR22_1_2M_FD() == null ? BigDecimal.ZERO : record.getR22_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR23 =
	    (record.getR23_1_2M_FD() == null ? BigDecimal.ZERO : record.getR23_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR24 =
	    (record.getR24_1_2M_FD() == null ? BigDecimal.ZERO : record.getR24_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR26 =
	    (record.getR26_1_2M_FD() == null ? BigDecimal.ZERO : record.getR26_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR34 =
	    (record.getR34_1_2M_FD() == null ? BigDecimal.ZERO : record.getR34_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR35 =
	    (record.getR35_1_2M_FD() == null ? BigDecimal.ZERO : record.getR35_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR36 =
	    (record.getR36_1_2M_FD() == null ? BigDecimal.ZERO : record.getR36_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR37 =
	    (record.getR37_1_2M_FD() == null ? BigDecimal.ZERO : record.getR37_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR38 =
	    (record.getR38_1_2M_FD() == null ? BigDecimal.ZERO : record.getR38_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR39 =
	    (record.getR39_1_2M_FD() == null ? BigDecimal.ZERO : record.getR39_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR40 =
	    (record.getR40_1_2M_FD() == null ? BigDecimal.ZERO : record.getR40_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR41 =
	    (record.getR41_1_2M_FD() == null ? BigDecimal.ZERO : record.getR41_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR42 =
	    (record.getR42_1_2M_FD() == null ? BigDecimal.ZERO : record.getR42_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR43 =
	    (record.getR43_1_2M_FD() == null ? BigDecimal.ZERO : record.getR43_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR44 =
	    (record.getR44_1_2M_FD() == null ? BigDecimal.ZERO : record.getR44_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR45 =
	    (record.getR45_1_2M_FD() == null ? BigDecimal.ZERO : record.getR45_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR46 =
	    (record.getR46_1_2M_FD() == null ? BigDecimal.ZERO : record.getR46_1_2M_FD())
	...
	cell8 = row.createCell(9);
	BigDecimal totalR47 =
	    (record.getR47_1_2M_FD() == null ? BigDecimal.ZERO : record.getR47_1_2M_FD())
