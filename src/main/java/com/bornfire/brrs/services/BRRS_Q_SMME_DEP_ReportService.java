...
public class BRRS_Q_SMME_DEP_ReportService {
	...
	public ModelAndView getQ_SMME_DEPview(String reportId, String fromdate, String todate, String currency,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			...
			List<Q_SMME_DEP_Archival_Summary_Entity> T1Master = new ArrayList<Q_SMME_DEP_Archival_Summary_Entity>();
			System.out.println(version);
			try {
				...
				T1Master = BRRS_Q_SMME_DEP_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
			...
			List<Q_SMME_DEP_Summary_Entity> T1Master = new ArrayList<Q_SMME_DEP_Summary_Entity>();
			try {
				Date d1 = dateformat.parse(todate);
...
//					row = sheet.getRow(47);
	...
	public List<Object> getQ_SMME_DEPArchival() {
		...
		try {
			Q_SMME_DEPArchivallist = BRRS_Q_SMME_DEP_Archival_Summary_Repo.getQ_SMME_DEParchival();
