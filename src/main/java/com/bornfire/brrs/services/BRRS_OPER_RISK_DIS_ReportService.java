...
//=====================================================
	...
	public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
		try {
			...
			OPER_RISK_DIS_Detail_Entity oldcopy = new OPER_RISK_DIS_Detail_Entity();
    ...
    existing.getAcctNumber()
		        ...
		        // Audit comparison
		            auditService.compareEntitiesmanual(
		                    ...
		                    existing,
		                    acctNo,
		                    "OPER_RISK_DIS Detail Screen",
		                    "BRRS_OPER_RISK_DIS_DETAIL"
		            );
	...
	// Write the final workbook content to the in-memory stream.
				...
				ServletRequestAttributes attrs = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
											if (attrs != null) {
												...
												auditService.createBusinessAudit(userid, "DOWNLOAD", "OPER_RISK_DIS  SUMMARY", null, "BRRS_OPER_RISK_DIS_SUMMARYTABLE");
											}
...
ServletRequestAttributes attrs = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
		if (attrs != null) {
			HttpServletRequest request = attrs.getRequest();
			String userid = (String) request.getSession().getAttribute("USERID");
			auditService.createBusinessAudit(userid, "DOWNLOAD", "OPER_RISK_DIS ARCHIVAL SUMMARY", null, "BRRS_OPER_RISK_DIS_ARCHIVALTABLE_SUMMARY");
		}
