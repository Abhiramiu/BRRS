...
public class BRRS_MDISB1_ReportService {
		...
		try {
			...
			if ("ARCHIVAL".equals(type) && version != null) {
				...
				if (rowId != null && columnId != null) {
					T1Dt1 = brrs_MDISB1_Archival_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate, version);
				} else {
	...
	public byte[] getMDISB1Archival(String filename, String reportId, String fromdate, String todate,
