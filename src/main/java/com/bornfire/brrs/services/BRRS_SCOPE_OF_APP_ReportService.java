...
//=====================================================
	...
	public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
		try {
			...
			SCOPE_OF_APP_Detail_Entity oldcopy = new SCOPE_OF_APP_Detail_Entity();
    ...
    existing.getAcctNumber()
		        ...
		        // Audit comparison
		            auditService.compareEntitiesmanual(
		                    ...
		                    existing,
		                    acctNo,
		                    "SCOPE_OF_APP Detail Screen",
		                    "BRRS_SCOPE_OF_APP_DETAIL"
		            );
	...
	// Write the final workbook content to the in-memory stream.
				...
				ServletRequestAttributes attrs = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
											if (attrs != null) {
												...
												auditService.createBusinessAudit(userid, "DOWNLOAD", "SCOPE_OF_APP  SUMMARY", null, "BRRS_SCOPE_OF_APP_SUMMARYTABLE");
											}
...
ServletRequestAttributes attrs = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
		if (attrs != null) {
			HttpServletRequest request = attrs.getRequest();
			String userid = (String) request.getSession().getAttribute("USERID");
			auditService.createBusinessAudit(userid, "DOWNLOAD", "SCOPE_OF_APP ARCHIVAL SUMMARY", null, "BRRS_SCOPE_OF_APP_ARCHIVALTABLE_SUMMARY");
		}
