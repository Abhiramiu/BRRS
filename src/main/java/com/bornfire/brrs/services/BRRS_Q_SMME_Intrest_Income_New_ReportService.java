...
import com.bornfire.brrs.entities.BRRS_Q_SMME_Intrest_Income_New_Summary_Repo;
import com.bornfire.brrs.entities.Q_SMME_Intrest_Income_New_Archival_Detail_Entity;
import com.bornfire.brrs.entities.Q_SMME_Intrest_Income_New_Archival_Summary_Entity;
import com.bornfire.brrs.entities.Q_SMME_Intrest_Income_New_Detail_Entity;
import com.bornfire.brrs.entities.Q_SMME_Intrest_Income_New_Summary_Entity;
...
public class BRRS_Q_SMME_Intrest_Income_New_ReportService {
    ...
    @Autowired
    BRRS_Q_SMME_Intrest_Income_New_Detail_Repo q_SMME_Detail_Repo;

    @Autowired
    BRRS_Q_SMME_Intrest_Income_New_Summary_Repo q_SMME_Summary_Repo;

    @Autowired
    BRRS_Q_SMME_Intrest_Income_New_Archival_Detail_Repo Q_SMME_Archival_Detail_Repo;

    @Autowired
    BRRS_Q_SMME_Intrest_Income_New_Archival_Summary_Repo Q_SMME_Archival_Summary_Repo;
    ...
    public ModelAndView getBRRS_Q_SMMEView(String reportId, String fromdate, String todate, 
        ...
        if (type.equals("ARCHIVAL") & version != null) {
            ...
            List<Q_SMME_Intrest_Income_New_Archival_Summary_Entity> T1Master = new ArrayList<Q_SMME_Intrest_Income_New_Archival_Summary_Entity>();
            System.out.println(version);
            try {
            ...
            List<Q_SMME_Intrest_Income_New_Summary_Entity> T1Master = new ArrayList<Q_SMME_Intrest_Income_New_Summary_Entity>();
            try {
                Date d1 = dateformat.parse(todate);
        ...
        mv.setViewName("BRRS/Q_SMME_New");
    ...
    public ModelAndView getBRRS_Q_SMMEcurrentDtl(String reportId, String fromdate, String todate, String currency,
        ...
        try {
            ...
            if ("ARCHIVAL".equals(type) && version != null) {
                ...
                System.out.println(version);
                // 🔹 Archival branch
                List<Q_SMME_Intrest_Income_New_Archival_Detail_Entity> T1Dt1;
                ...
                // 🔹 Current branch
                List<Q_SMME_Intrest_Income_New_Detail_Entity> T1Dt1;
                if (reportLabel != null && reportAddlCriteria1 != null) {
...
public byte[] getQ_SMMEExcel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		try (InputStream templateInputStream = Files.newInputStream(templatePath);
            ...
            if (!dataList.isEmpty()) {
                for (int i = 0; i < dataList.size(); i++) {
                    Q_SMME_Intrest_Income_New_Summary_Entity record = dataList.get(i);
                    ...
                    // row16
                    // Column 1
                    Cell R14cell2 = row.createCell(6);
                    if (record.getR15_res_carry_amt() != null) {
                        R14cell2.setCellValue(record.getR15_res_carry_amt().doubleValue());
                    ...
                    if (record.getR15_non_res_carry_amt() != null) {
                        R14cell3.setCellValue(record.getR15_non_res_carry_amt().doubleValue());
                    ...
                    // ================== ROW 28 ==================
                    row = sheet.getRow(28);
                    Cell R28cell2 = row.createCell(6);
                    if (record.getR29_res_carry_amt() != null) {
                        R28cell2.setCellValue(record.getR29_res_carry_amt().doubleValue());
                    ...
                    Cell R28cell3 = row.createCell(7);
                    if (record.getR29_non_res_carry_amt() != null) {
                        R28cell3.setCellValue(record.getR29_non_res_carry_amt().doubleValue());
                    ...
                    // ================== ROW 34 ==================
                    row = sheet.getRow(32);
                    Cell R32cell2 = row.createCell(6);
                    if (record.getR33_res_carry_amt() != null) {
                        R32cell2.setCellValue(record.getR33_res_carry_amt().doubleValue());
                    ...
                    Cell R32cell3 = row.createCell(7);
                    if (record.getR33_non_res_carry_amt() != null) {
                        R32cell3.setCellValue(record.getR33_non_res_carry_amt().doubleValue());
                    ...
                    // ================== ROW 37 ==================
                    row = sheet.getRow(36);
                    Cell R36cell2 = row.createCell(6);
                    if (record.getR37_res_carry_amt() != null) {
                        R36cell2.setCellValue(record.getR37_res_carry_amt().doubleValue());
                    ...
                    Cell R36cell3 = row.createCell(7);
                    if (record.getR37_non_res_carry_amt() != null) {
                        R36cell3.setCellValue(record.getR37_non_res_carry_amt().doubleValue());
         ...
         // audit service summary email
            ...
            ServletRequestAttributes attrs = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
            					if (attrs != null) {
            						...
            						auditService.createBusinessAudit(userid, "DOWNLOAD", "Q_SMME_INTREST_INCOME_NEW EMAIL SUMMARY", null, "BRRS_Q_SMME_INTREST_INCOME_NEW_ARCHIVALTABLE_SUMMARY");
            					}
    ...
    public byte[] BRRS_Q_SMMEDetailExcel(String filename, String fromdate, String todate, String currency,
        ...
        try {
            ...
            List<Q_SMME_Intrest_Income_New_Detail_Entity> reportData = q_SMME_Detail_Repo
                    .getdatabydateList(parsedToDate);

            if (reportData != null && !reportData.isEmpty()) {
                int rowIndex = 1;
                for (Q_SMME_Intrest_Income_New_Detail_Entity item : reportData) {
    ...
    public byte[] getSummaryExcelARCHIVAL(String filename, String reportId, String fromdate,
        ...
        List<Q_SMME_Intrest_Income_New_Archival_Summary_Entity> dataList = Q_SMME_Archival_Summary_Repo
        ...
        try (InputStream templateInputStream = Files.newInputStream(templatePath);
            ...
            if (!dataList.isEmpty()) {
                for (int i = 0; i < dataList.size(); i++) {
                    Q_SMME_Intrest_Income_New_Archival_Summary_Entity record = dataList.get(i);
                    System.out.println("rownumber=" + startRow + i);
                    Row row = sheet.getRow(startRow + i);
                    if (row == null) {
                        row = sheet.createRow(startRow + i);
         ...
         // audit service archival summary email
        	...
        	ServletRequestAttributes attrs = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
        					if (attrs != null) {
        						HttpServletRequest request = attrs.getRequest();
        						String userid = (String) request.getSession().getAttribute("USERID");
        						auditService.createBusinessAudit(userid, "DOWNLOAD", "Q_SMME_INTREST_INCOME_NEW EMAIL ARCHIVAL SUMMARY", null, "BRRS_Q_SMME_INTREST_INCOME_NEW_ARCHIVALTABLE_SUMMARY");
        					}
    ...
    public byte[] getDetailExcelARCHIVAL(String filename,
        ...
        try {
            ...
            List<Q_SMME_Intrest_Income_New_Archival_Detail_Entity> reportData = Q_SMME_Archival_Detail_Repo
            ...
            if (reportData != null && !reportData.isEmpty()) {
                int rowIndex = 1;
                for (Q_SMME_Intrest_Income_New_Archival_Detail_Entity item : reportData) {
                    XSSFRow row = sheet.createRow(rowIndex++);
    ...
    public ModelAndView getViewOrEditPage(String acctNo, String formMode) {
        ...
        if (acctNo != null) {
            Q_SMME_Intrest_Income_New_Detail_Entity q_smmeIi = q_SMME_Detail_Repo.findByAcctnumber(acctNo);
    ...
    public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
        try {
            ...
            Q_SMME_Intrest_Income_New_Detail_Entity existing = q_SMME_Detail_Repo.findByAcctnumber(acctNo);
