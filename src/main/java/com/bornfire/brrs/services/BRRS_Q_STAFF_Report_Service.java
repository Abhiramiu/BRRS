...
public class BRRS_Q_STAFF_Report_Service {
	...
	@Autowired
	BRRS_Q_STAFF_Detail_Repo brrs_Q_STAFF_detail_repo;

	@Autowired
	BRRS_Q_STAFF_Archival_Summary_Repo Q_STAFF_Archival_Summary_Repo;

	@Autowired
	BRRS_Q_STAFF_Archival_Detail_Repo BRRS_Q_STAFF_Archival_Detail_Repo;

	@Autowired
	BRRS_Q_STAFF_Resub_Summary_Repo brrs_Q_STAFF_resub_summary_repo;
	...
	public ModelAndView getQ_STAFFView(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		try {
			...
			// ---------- RESUB SUMMARY ----------
				...
				List<Q_STAFF_Resub_Summary_Entity> T1Master = brrs_Q_STAFF_resub_summary_repo
						.getdatabydateListarchival(d1, version);
			...
			// ---------- NORMAL SUMMARY ----------
				...
				List<Q_STAFF_Summary_Entity> T1Master = brrs_Q_STAFF_summary_repo.getdatabydateList(d1);
			...
			if ("detail".equalsIgnoreCase(dtltype)) {
				...
				if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
					...
					List<Q_STAFF_Archival_Detail_Entity> T1Master = BRRS_Q_STAFF_Archival_Detail_Repo
							.getdatabydateListarchival(d1, version);
				...
				// ---------- RESUB DETAIL ----------
					...
					List<Q_STAFF_Resub_Detail_Entity> T1Master = brrs_Q_STAFF_resub_detail_repo
							.getdatabydateListarchival(d1, version);
				...
				// ---------- NORMAL DETAIL ----------
					...
					List<Q_STAFF_Detail_Entity> T1Master = brrs_Q_STAFF_detail_repo.getdatabydateList(d1);
	...
	public void updateResubReport(Q_STAFF_Resub_Summary_Entity updatedEntity) {
		...
		BigDecimal maxResubVer = brrs_Q_STAFF_resub_summary_repo.findMaxVersion(reportDate);
		...
		brrs_Q_STAFF_resub_summary_repo.save(resubSummary);
		brrs_Q_STAFF_resub_detail_repo.save(resubDetail);

		Q_STAFF_Archival_Summary_Repo.save(archSummary);
		BRRS_Q_STAFF_Archival_Detail_Repo.save(archDetail);
	}
	...
	public byte[] getBRRS_Q_STAFFExcel(String filename, String reportId, String fromdate, String todate,
		...
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
			...
			if ("email".equalsIgnoreCase(format) && version == null) {
				...
				List<Q_STAFF_Summary_Entity> dataList = brrs_Q_STAFF_summary_repo
...
// R9 Col B
	...
	public byte[] BRRS_Q_STAFFEmailExcel(String filename, String reportId, String fromdate, String todate,
		...
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
			...
			try {
				// ✅ Redirecting to Resub Excel
				return BRRS_Q_STAFFResubEmailExcel(filename, reportId, fromdate, todate, currency, dtltype, type,
						version);
...
// Write the final workbook content to the in-memory stream.
	...
	public byte[] BRRS_Q_STAFFResubExcel(String filename, String reportId, String fromdate, String todate,
		...
		List<Q_STAFF_Resub_Summary_Entity> dataList = brrs_Q_STAFF_resub_summary_repo
				.getdatabydateListarchival(dateformat.parse(todate), version);
...
// R9 Col B
	...
	// Resub Email Excel
	public byte[] BRRS_Q_STAFFResubEmailExcel(String filename, String reportId, String fromdate, String todate,
			String currency, String dtltype, String type, BigDecimal version) throws Exception {
