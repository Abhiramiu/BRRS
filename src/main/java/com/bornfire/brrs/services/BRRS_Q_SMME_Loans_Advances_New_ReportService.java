...
import com.bornfire.brrs.entities.BRRS_Q_SMME_Loans_Advances_New_Summary_Repo;
import com.bornfire.brrs.entities.Q_SMME_Loans_Advances_New_Archival_Detail_Entity;
import com.bornfire.brrs.entities.Q_SMME_Loans_Advances_New_Archival_Summary_Entity;
import com.bornfire.brrs.entities.Q_SMME_Loans_Advances_New_Detail_Entity;
import com.bornfire.brrs.entities.Q_SMME_Loans_Advances_New_Summary_Entity;

@Component
@Service

public class BRRS_Q_SMME_Loans_Advances_New_ReportService<BBRS_Q_SMME_Detail_Repo> {
    private static final Logger logger = LoggerFactory.getLogger(BRRS_Q_SMME_Loans_Advances_New_ReportService.class);
    ...
    @Autowired
    BRRS_Q_SMME_Loans_Advances_New_Detail_Repo q_SMME_Detail_Repo;

    @Autowired
    BRRS_Q_SMME_Loans_Advances_New_Summary_Repo q_SMME_Summary_Repo;

    @Autowired
    BRRS_Q_SMME_Loans_Advances_New_Archival_Detail_Repo Q_SMME_Archival_Detail_Repo;

    @Autowired
    BRRS_Q_SMME_Loans_Advances_New_Archival_Summary_Repo Q_SMME_Archival_Summary_Repo;
    ...
    public ModelAndView getBRRS_Q_SMMEView(String reportId, String fromdate, String todate, String currency,
        ...
        if (type.equals("ARCHIVAL") & version != null) {
            ...
            List<Q_SMME_Loans_Advances_New_Archival_Summary_Entity> T1Master = new ArrayList<Q_SMME_Loans_Advances_New_Archival_Summary_Entity>();
            System.out.println(version);
            try {
            ...
            List<Q_SMME_Loans_Advances_New_Summary_Entity> T1Master = new ArrayList<Q_SMME_Loans_Advances_New_Summary_Entity>();
            try {
                Date d1 = dateformat.parse(todate);
        ...
        mv.setViewName("BRRS/Q_SMME_LA_New");
    ...
    public ModelAndView getBRRS_Q_SMMEcurrentDtl(String reportId, String fromdate, String todate, String currency,
        ...
        try {
            ...
            if ("ARCHIVAL".equals(type) && version != null) {
                ...
                System.out.println(version);
                // 🔹 Archival branch
                List<Q_SMME_Loans_Advances_New_Archival_Detail_Entity> T1Dt1;
                ...
                // 🔹 Current branch
                List<Q_SMME_Loans_Advances_New_Detail_Entity> T1Dt1;
                if (reportLabel != null && reportAddlCriteria1 != null) {
    ...
    public byte[] getQ_SMMEExcel(String filename, String reportId, String fromdate, String todate, String currency,
        ...
        // Fetch data
        List<Q_SMME_Loans_Advances_New_Summary_Entity> dataList = q_SMME_Summary_Repo
        ...
        try (InputStream templateInputStream = Files.newInputStream(templatePath);
            ...
            if (!dataList.isEmpty()) {
                for (int i = 0; i < dataList.size(); i++) {
                    Q_SMME_Loans_Advances_New_Summary_Entity record = dataList.get(i);
                    ...
                    // ================== ROW 37 ==================
                    row = sheet.getRow(36);
                    Cell R36cell2 = row.createCell(5);
                    ...
                    Cell R36cell3 = row.createCell(6);
    ...
    public byte[] BRRS_Q_SMMEDetailExcel(String filename, String fromdate, String todate, String currency,
        ...
        try {
            ...
            List<Q_SMME_Loans_Advances_New_Detail_Entity> reportData = q_SMME_Detail_Repo
                    .getdatabydateList(parsedToDate);

            if (reportData != null && !reportData.isEmpty()) {
                int rowIndex = 1;
                for (Q_SMME_Loans_Advances_New_Detail_Entity item : reportData) {
    ...
    public byte[] getSummaryExcelARCHIVAL(String filename, String reportId, String fromdate, String todate,
        ...
        List<Q_SMME_Loans_Advances_New_Archival_Summary_Entity> dataList = Q_SMME_Archival_Summary_Repo
        ...
        try (InputStream templateInputStream = Files.newInputStream(templatePath);
            ...
            if (!dataList.isEmpty()) {
                for (int i = 0; i < dataList.size(); i++) {
                    Q_SMME_Loans_Advances_New_Archival_Summary_Entity record = dataList.get(i);
                    System.out.println("rownumber=" + startRow + i);
                    Row row = sheet.getRow(startRow + i);
                    if (row == null) {
                        row = sheet.createRow(startRow + i);
    ...
    public byte[] getDetailExcelARCHIVAL(String filename,
        ...
        try {
            ...
            List<Q_SMME_Loans_Advances_New_Archival_Detail_Entity> reportData = Q_SMME_Archival_Detail_Repo
            ...
            if (reportData != null && !reportData.isEmpty()) {
                int rowIndex = 1;
                for (Q_SMME_Loans_Advances_New_Archival_Detail_Entity item : reportData) {
                    XSSFRow row = sheet.createRow(rowIndex++);
    ...
    public ModelAndView getViewOrEditPage(String acctNo, String formMode) {
        ...
        if (acctNo != null) {
            Q_SMME_Loans_Advances_New_Detail_Entity q_smmeIi = q_SMME_Detail_Repo.findByAcctnumber(acctNo);
    ...
    public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
        try {
            ...
            Q_SMME_Loans_Advances_New_Detail_Entity existing = q_SMME_Detail_Repo.findByAcctnumber(acctNo);
