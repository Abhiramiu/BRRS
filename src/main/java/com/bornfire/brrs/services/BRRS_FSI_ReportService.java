...
public class BRRS_FSI_ReportService {
	...
	@Autowired
	BRRS_FSI_Detail_Repo BRRS_FSI_Detail_Repo;

	@Autowired
	BRRS_FSI_Summary_Repo BRRS_FSI_Summary_Repo;

//	@Autowired
//	BRRS_FSI_Manual_Summary_Repo BRRS_FSI_Manual_Summary_Repo;
//

	@Autowired
	BRRS_FSI_Archival_Detail_Repo BRRS_FSI_Archival_Detail_Repo;

	@Autowired
	BRRS_FSI_Archival_Summary_Repo BRRS_FSI_Archival_Summary_Repo;

//	@Autowired
//	BRRS_FSI_Manual_Archival_Summary_Repo BRRS_FSI_Manual_Archival_Summary_Repo;
//
...
//		int startItem = currentPage * pageSize;
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<FSI_Archival_Summary_Entity> T1Master = new ArrayList<FSI_Archival_Summary_Entity>();
//			List<FSI_Manual_Archival_Summary_Entity> T2Master = new ArrayList<FSI_Manual_Archival_Summary_Entity>();
			...
			try {
				...
				T1Master = BRRS_FSI_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
...
//			mv.addObject("reportsummary1", T2Master);
			...
			List<FSI_Summary_Entity> T1Master = new ArrayList<FSI_Summary_Entity>();
//			List<FSI_Manual_Summary_Entity> T2Master = new ArrayList<FSI_Manual_Summary_Entity>();
			...
			try {
				...
				// ", BRF1_REPORT_ENTITY.class)
				// .setParameter(1, df.parse(todate)).getResultList();
				T1Master = BRRS_FSI_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
//	public void updateReport(FSI_Manual_Summary_Entity updatedEntity) {
//	    System.out.println("Came to services1");
//	    System.out.println("Report Date: " + updatedEntity.getReport_date());
//
//	    FSI_Manual_Summary_Entity existing = BRRS_FSI_Manual_Summary_Repo.findById(updatedEntity.getReport_date())
...
//
//	                    Method getter = FSI_Manual_Summary_Entity.class.getMethod(getterName);
//	                    Method setter = FSI_Manual_Summary_Entity.class.getMethod(setterName, getter.getReturnType());
//
...
//	        BRRS_FSI_Manual_Summary_Repo.save(existing);
//
//	    } catch (Exception e) {
...
//	}
	...
	public byte[] getFSIDetailExcel(String filename, String fromdate, String todate, String currency,
...
List<FSI_Detail_Entity> reportData = BRRS_FSI_Detail_Repo.getdatabydateList(parsedToDate);
...
//	public byte[] BRRS_FSIDetailExcel(String filename, String fromdate, String todate, String currency, String dtltype,
//			String type, String version) {
//
//		try {
//			logger.info("Generating Excel for BRRS_FSIDetails...");
//			System.out.println("came to Detail download service");
//			if (type.equals("ARCHIVAL") & version != null) {
//				byte[] ARCHIVALreport = getDetailExcelARCHIVAL(filename, fromdate, todate, currency, dtltype, type,
//						version);
...
//			}
//			XSSFWorkbook workbook = new XSSFWorkbook();
//			XSSFSheet sheet = workbook.createSheet("BRRS_FSIDetails");
//
//			// Common border style
//			BorderStyle border = BorderStyle.THIN;
//			// Header style (left aligned)
...
//				}
//			} else {
//				logger.info("No data found for BRRS_FSI— only header will be written.");
//			}
//			// Write to byte[]
//			ByteArrayOutputStream bos = new ByteArrayOutputStream();
//			workbook.write(bos);
...
//			return bos.toByteArray();
//		} catch (Exception e) {
//			logger.error("Error generating BRRS_FSIExcel", e);
//			return new byte[0];
//		}
//	}

//	public byte[] BRRS_FSIExcel(String filename, String reportId, String fromdate, String todate, String currency,
...
//
//		// Fetch data
//		List<FSI_Summary_Entity> dataList = BRRS_FSI_Summary_Repo.getdatabydateList(dateformat.parse(todate));
////		List<FSI_Manual_Summary_Entity> dataList1 = BRRS_FSI_Manual_Summary_Repo.getdatabydateList(dateformat.parse(todate));
//
//
//		if (dataList.isEmpty()) {
...
////					FSI_Manual_Summary_Entity record1 = dataList1.get(i);
//					
...
//	}
	...
	public List<Object> getFSIArchival() {
		List<Object> FSIArchivallist = new ArrayList<>();
		try {
			FSIArchivallist = BRRS_FSI_Archival_Summary_Repo.getFSIarchival();
//			FSIArchivallist = BRRS_FSI_Manual_Archival_Summary_Repo.getFSIarchival();
			System.out.println("countser" + FSIArchivallist.size());
		} catch (Exception e) {
			// Log the exception
	...
	public byte[] getDetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency,
			 String dtltype, String type, String version) {
try {
logger.info("Generating Excel for BRRS_FSI ARCHIVAL Details...");
System.out.println("came to Detail download service");
if (type.equals("ARCHIVAL") & version != null) {
...
// Get data
Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
List<FSI_Archival_Detail_Entity> reportData = BRRS_FSI_Archival_Detail_Repo.getdatabydateList(parsedToDate,version);
...
//
//	public byte[] getExcelFSIARCHIVAL(String filename, String reportId, String fromdate, String todate,
//			String currency, String dtltype, String type, String version) throws Exception {
//		logger.info("Service: Starting Excel generation process in memory.");
//		if (type.equals("ARCHIVAL") & version != null) {
//
//		}
//		List<FSI_Archival_Summary_Entity> dataList = BRRS_FSI_Archival_Summary_Repo
//				.getdatabydateListarchival(dateformat.parse(todate), version);
//		List<FSI_Manual_Archival_Summary_Entity> dataList1 = BRRS_FSI_Manual_Archival_Summary_Repo
//				.getdatabydateListarchival(dateformat.parse(todate), version);
//
//		if (dataList.isEmpty()) {
...
//					FSI_Manual_Archival_Summary_Entity record1 = dataList1.get(i);
//
//					System.out.println("rownumber=" + startRow + i);
//					Row row = sheet.getRow(startRow + i);
//					if (row == null) {
...
//	}
	...
	public ModelAndView getViewOrEditPage(String acctNo, String formMode) {
	    ModelAndView mv = new ModelAndView("BRRS/FSI"); // ✅ match the report name
	    System.out.println("Hello");
	    if (acctNo != null) {
	    	FSI_Detail_Entity fsiEntity = BRRS_FSI_Detail_Repo.findByAcctnumber(acctNo);
	...
	public ModelAndView updateDetailEdit(String acctNo, String formMode) {
	    ...
	    if (acctNo != null) {
	        FSI_Detail_Entity la1Entity = BRRS_FSI_Detail_Repo.findByAcctnumber(acctNo);
	...
	public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
	    try {
	        ...
	        FSI_Detail_Entity existing = BRRS_FSI_Detail_Repo.findByAcctnumber(acctNo);
	        if (existing == null) {
	        ...
	        if (isChanged) {
	        	BRRS_FSI_Detail_Repo.save(existing);
	            ...
	            TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronizationAdapter() {
	                ...
	                public void afterCommit() {
	                    try {
	                        logger.info("Transaction committed — calling BRRS_FSI_SUMMARY_PROCEDURE({})",
	                                formattedDate);
	        ...
	        logger.error("Error updating FSI record", e);
