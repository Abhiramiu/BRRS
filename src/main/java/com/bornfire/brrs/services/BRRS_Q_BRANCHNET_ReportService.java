...
import com.bornfire.brrs.entities.BRRS_Q_BRANCHNET_Resub_Detail_Repo;
import com.bornfire.brrs.entities.BRRS_Q_BRANCHNET_Resub_Summary_Repo;
...
import com.bornfire.brrs.entities.Q_BRANCHNET_Resub_Detail_Entity;
import com.bornfire.brrs.entities.Q_BRANCHNET_Resub_Summary_Entity;
...
public class BRRS_Q_BRANCHNET_ReportService {
	...
	@Autowired
	BRRS_Q_BRANCHNET_Summary_Repo brrs_Q_BRANCHNET_summary_repo;

	@Autowired
	BRRS_Q_BRANCHNET_Detail_Repo brrs_Q_BRANCHNET_detail_repo;

	@Autowired
	BRRS_Q_BRANCHNET_Archival_Summary_Repo Q_BRANCHNET_Archival_Summary_Repo;

	@Autowired
	BRRS_Q_BRANCHNET_Archival_Detail_Repo BRRS_Q_BRANCHNET_Archival_Detail_Repo;

	@Autowired
	BRRS_Q_BRANCHNET_Resub_Summary_Repo brrs_Q_BRANCHNET_resub_summary_repo;

	@Autowired
	BRRS_Q_BRANCHNET_Resub_Detail_Repo brrs_Q_BRANCHNET_resub_detail_repo;
	...
	public ModelAndView getQ_BRANCHNETView(String reportId, String fromdate, String todate, String currency,
		...
		try {
			...
			// ---------- CASE 2: RESUB ----------
				...
				List<Q_BRANCHNET_Resub_Summary_Entity> T1Master = brrs_Q_BRANCHNET_resub_summary_repo
						.getdatabydateListarchival(d1, version);
			...
			// ---------- CASE 3: NORMAL ----------
				...
				List<Q_BRANCHNET_Summary_Entity> T1Master = brrs_Q_BRANCHNET_summary_repo.getdatabydateList(d1);
			...
			if ("detail".equalsIgnoreCase(dtltype)) {
				...
				// ---------- RESUB DETAIL ----------
					...
					List<Q_BRANCHNET_Resub_Detail_Entity> T1Master = brrs_Q_BRANCHNET_resub_detail_repo
							.getdatabydateListarchival(d1, version);
	...
	public void updateResubReport(Q_BRANCHNET_Resub_Summary_Entity updatedEntity) {
		...
		BigDecimal maxResubVer = brrs_Q_BRANCHNET_resub_summary_repo.findMaxVersion(reportDate);
		...
		Q_BRANCHNET_Archival_Summary_Entity archSummary = new Q_BRANCHNET_Archival_Summary_Entity();
		...
		Q_BRANCHNET_Archival_Detail_Entity archDetail = new Q_BRANCHNET_Archival_Detail_Entity();
		...
		brrs_Q_BRANCHNET_resub_summary_repo.save(resubSummary);
		brrs_Q_BRANCHNET_resub_detail_repo.save(resubDetail);

		Q_BRANCHNET_Archival_Summary_Repo.save(archSummary);
		BRRS_Q_BRANCHNET_Archival_Detail_Repo.save(archDetail);
	}
	...
	public List<Object[]> getQ_BRANCHNETArchival() {
		...
		try {
			List<Q_BRANCHNET_Archival_Summary_Entity> repoData = Q_BRANCHNET_Archival_Summary_Repo
					.getdatabydateListWithVersion();
	...
	public byte[] BRRS_Q_BRANCHNETExcel(String filename, String reportId, String fromdate, String todate,
		...
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
			...
			if ("email".equalsIgnoreCase(format) && version == null) {
				...
				List<Q_BRANCHNET_Summary_Entity> dataList = brrs_Q_BRANCHNET_summary_repo
						.getdatabydateList(dateformat.parse(todate));
...
//NORMAL
	...
	public byte[] BRRS_Q_BRANCHNETEmailExcel(String filename, String reportId, String fromdate, String todate,
		...
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
			...
			try {
				// ✅ Redirecting to Resub Excel
				return BRRS_Q_BRANCHNETResubEmailExcel(filename, reportId, fromdate, todate, currency, dtltype, type,
						version);
...
// Write the final workbook content to the in-memory stream.
	...
	public byte[] BRRS_Q_BRANCHNETEmailArchivalExcel(String filename, String reportId, String fromdate, String todate,
			String currency, String dtltype, String type, BigDecimal version) throws Exception {
...
// R10 Col E
	...
	public byte[] BRRS_Q_BRANCHNETResubExcel(String filename, String reportId, String fromdate, String todate,
		...
		List<Q_BRANCHNET_Resub_Summary_Entity> dataList = brrs_Q_BRANCHNET_resub_summary_repo
				.getdatabydateListarchival(dateformat.parse(todate), version);
...
//NORMAL
	...
	// Resub Email Excel
	public byte[] BRRS_Q_BRANCHNETResubEmailExcel(String filename, String reportId, String fromdate, String todate,
			String currency, String dtltype, String type, BigDecimal version) throws Exception {
