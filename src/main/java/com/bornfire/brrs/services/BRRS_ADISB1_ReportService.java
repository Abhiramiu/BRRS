...
//		int startItem = currentPage * pageSize;
		...
		if (type.equals("ARCHIVAL") & version != null) {
			...
			try {
				...
				T1Master = BRRS_ADISB1_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate),
						version);
				T2Master = BRRS_ADISB1_Manual_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate),
						version);
...
//	Session hs = sessionFactory.getCurrentSession();
		...
		try {
			...
			if ("ARCHIVAL".equals(type) && version != null) {
				...
				List<ADISB1_Archival_Detail_Entity> T1Dt1;
				if (rowId != null && columnId != null) {
					T1Dt1 = BRRS_ADISB1_Archival_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate,
							version);
				} else {
					T1Dt1 = BRRS_ADISB1_Archival_Detail_Repo.getdatabydateList(parsedDate, version);
				}
			...
			for (int i : Rows) {
				...
				for (String field : fields) {
					try {
						...
						Method setter = ADISB1_Manual_Summary_Entity.class.getMethod(setterName,
...
//	}
	...
	public byte[] BRRS_ADISB1Excel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		List<ADISB1_Manual_Summary_Entity> dataList1 = BRRS_ADISB1_Manual_Summary_Repo
...
// Get data
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<ADISB1_Archival_Detail_Entity> reportData = BRRS_ADISB1_Archival_Detail_Repo
