...
// .setParameter(1, df.parse(todate)).getResultList();
				T1Master = M_SRWA_12F_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate),
						version);
...
//		List<Object> M_SRWA_12GArchivallist3 = new ArrayList<>();
		try {
			M_SRWA_12FArchivallist = M_SRWA_12F_Archival_Summary_Repo.getM_SRWA12Farchival();
...
//			System.out.println("countser" + M_FXRArchivallist.size());
	...
	public byte[] getExcelM_SRWA12FARCHIVAL(String filename, String reportId, String fromdate, String todate,
