...
public class BRRS_M_INT_RATES_ReportService {
	...
	public ModelAndView getM_INTRATESView(String reportId, String fromdate, String todate, String currency,
...
// .setParameter(1, df.parse(todate)).getResultList();
				T1Master = M_INT_RATES_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate),
						version);
...
//			System.out.println("countser" + M_SRWA_12GArchivallist.size());
	...
	public void updateReport(M_INT_RATES_Summary_Entity updatedEntity) {
		...
		M_INT_RATES_Summary_Entity existing = M_INT_RATES_Summary_Repo.findById(updatedEntity.getReport_date())
	...
	public byte[] getM_INTRATESExcel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype , String type ,
			String version) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");
		
		// ARCHIVAL check
				if ("ARCHIVAL".equals(type) && version != null) {
					byte[] ARCHIVALreport = getExcelM_INTRATESARCHIVAL(filename, reportId, fromdate, 
