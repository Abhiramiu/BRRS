...
public class BRRS_M_SRWA_12G_ReportService {
	...
	public ModelAndView getM_SRWA_12GView(String reportId, String fromdate, String todate, String currency,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<M_SRWA_12G_Archival_Summary_Entity> T1Master = new ArrayList<M_SRWA_12G_Archival_Summary_Entity>();
			try {
				...
				T1Master = BRRS_M_SRWA_12G_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
...
//
	...
	public byte[] getM_SRWA_12GExcel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		if ("ARCHIVAL".equals(type) && version != null) {
			byte[] ARCHIVALreport = getExcelM_SRWA_12GARCHIVAL(filename, reportId, fromdate, 
		...
		List<M_SRWA_12G_Summary_Entity> dataList1 =BRRS_M_SRWA_12G_Summary_Repo.getdatabydateList(dateformat.parse(todate)) ;
