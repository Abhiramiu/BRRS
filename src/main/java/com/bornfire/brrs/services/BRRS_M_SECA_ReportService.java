...
import com.bornfire.brrs.entities.BRRS_M_SECA_Resub_Detail_Repo;
import com.bornfire.brrs.entities.BRRS_M_SECA_Resub_Summary_Repo;
...
import com.bornfire.brrs.entities.M_SECA_Resub_Detail_Entity;
import com.bornfire.brrs.entities.M_SECA_Resub_Summary_Entity;
...
public class BRRS_M_SECA_ReportService {
	...
	@Autowired
	BRRS_M_SECA_Resub_Summary_Repo BRRS_M_SECA_Resub_Summary_Repo;
	
	@Autowired
	BRRS_M_SECA_Resub_Detail_Repo BRRS_M_SECA_Resub_Detail_Repo;
	...
	public ModelAndView getM_SECAview(String reportId, String fromdate, String todate, String currency,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			...
			if(dtltype.equals("Details"))
			{
				List<M_SECA_Archival_Detail_Entity> T1Master = new ArrayList<M_SECA_Archival_Detail_Entity>();
				System.out.println(version);
				try {
					Date d1 = dateformat.parse(todate);
					T1Master = BRRS_M_SECA_Archival_Detail_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
		...
		else if(type.equals("RESUB") & version != null)
		{
			if(dtltype.equals("Details"))
			{
				List<M_SECA_Resub_Detail_Entity> T1Master = new ArrayList<M_SECA_Resub_Detail_Entity>();
				System.out.println(version);
				try {
					Date d1 = dateformat.parse(todate);
					T1Master = BRRS_M_SECA_Resub_Detail_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
			...
			{
			System.out.println(type);
			List<M_SECA_Resub_Summary_Entity> T1Master = new ArrayList<M_SECA_Resub_Summary_Entity>();
			System.out.println(version);
			try {
				Date d1 = dateformat.parse(todate);
				...
				// ", BRF1_REPORT_ENTITY.class)
				// .setParameter(1, df.parse(todate)).getResultList();
				T1Master = BRRS_M_SECA_Resub_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
			...
			if(dtltype.equals("Details"))
			{
				List<M_SECA_Detail_Entity> T2Master = new ArrayList<M_SECA_Detail_Entity>();
				try {
					Date d1 = dateformat.parse(todate);
				...
				//	T1Master = BRRS_M_SECA_Summary_Repo.getdatabydateList(dateformat.parse(todate));
					T2Master = BRRS_M_SECA_Detail_Repo.getdatabydateList(dateformat.parse(todate));

				} catch (ParseException e) {
					e.printStackTrace();
				}
				mv.addObject("reportsummary", T2Master);
				mv.addObject("displaymode", "Details");
			}
			else
			{
	...
	public void updateReportResub(M_SECA_Resub_Summary_Entity updatedEntity)
	{
		 System.out.println("Came to M_SECA_Resub Method !!");
		 BigDecimal newVersion = BigDecimal.ONE;
		 Date reportDate = updatedEntity.getReportDate();
		 try {
			 
		 
		 M_SECA_Resub_Summary_Entity resub_Summary_Entity = BRRS_M_SECA_Resub_Summary_Repo.getLatestArchivalVersionByDate(reportDate)
		            .orElseThrow(() -> new RuntimeException(
		                    "Record not found for REPORT_DATE: " + reportDate));
		 
		 if(resub_Summary_Entity != null)
		 {
			 try {
				 newVersion = (resub_Summary_Entity != null && resub_Summary_Entity.getReportVersion() != null)
							? resub_Summary_Entity.getReportVersion().add(BigDecimal.ONE)
							: BigDecimal.ONE;
			 } catch (Exception e)
			 {
		 ...
		 {
			 System.out.println("No previous Resub found for date: " + reportDate);
		 }
		 boolean exists = BRRS_M_SECA_Resub_Summary_Repo.findByReportDateAndReportVersion(reportDate, newVersion)
					.isPresent();
...
//---------Update The Data			
			M_SECA_Resub_Detail_Entity  Detail_Entity_resub = new M_SECA_Resub_Detail_Entity();
			org.springframework.beans.BeanUtils.copyProperties(updatedEntity, Detail_Entity_resub);
			Detail_Entity_resub.setReportDate(reportDate);
			Detail_Entity_resub.setReportVersion(newVersion);
			Detail_Entity_resub.setReportResubDate(new Date());
			
			M_SECA_Resub_Summary_Entity summary_Entity_resub = new M_SECA_Resub_Summary_Entity();
			org.springframework.beans.BeanUtils.copyProperties(updatedEntity, summary_Entity_resub);
			summary_Entity_resub.setReportDate(reportDate);
			summary_Entity_resub.setReportVersion(newVersion);
			summary_Entity_resub.setReportResubDate(new Date());
			
			M_SECA_Archival_Summary_Entity archival_Summary_Entity = new M_SECA_Archival_Summary_Entity();
			org.springframework.beans.	BeanUtils.copyProperties(updatedEntity, archival_Summary_Entity);
			archival_Summary_Entity.setReportDate(reportDate);
			archival_Summary_Entity.setReportVersion(newVersion);
			archival_Summary_Entity.setReportResubDate(new Date());
			
			M_SECA_Archival_Detail_Entity archival_Detail_Entity = new M_SECA_Archival_Detail_Entity();
			org.springframework.beans.BeanUtils.copyProperties(updatedEntity, archival_Detail_Entity);
			archival_Detail_Entity.setReportDate(reportDate);
			archival_Detail_Entity.setReportVersion(newVersion);
			archival_Detail_Entity.setReportResubDate(new Date());
			
//-----------Save			
			BRRS_M_SECA_Resub_Summary_Repo.save(summary_Entity_resub);
			BRRS_M_SECA_Resub_Detail_Repo.save(Detail_Entity_resub);
			BRRS_M_SECA_Archival_Summary_Repo.save(archival_Summary_Entity);
			BRRS_M_SECA_Archival_Detail_Repo.save(archival_Detail_Entity);
	 
     }
		 catch(Exception e)
		 {
			 e.printStackTrace();
				throw new RuntimeException("Error while creating SECA archival resubmission record", e);
		 }
	}
//------------------------------------------------------RESUB UPDATE END--------------------------------------------------------------------------	
	public void updateReport1(M_SECA_Summary_Entity updatedEntity) {
	    ...
	    M_SECA_Summary_Entity existing = BRRS_M_SECA_Summary_Repo.findById(updatedEntity.getReportDate())
	            .orElseThrow(() -> new RuntimeException(
	                    "Record not found for REPORT_DATE: " + updatedEntity.getReportDate()));
	    
	    M_SECA_Detail_Entity existingDetail = BRRS_M_SECA_Detail_Repo.findById(updatedEntity.getReportDate())
	            .orElseThrow(() -> new RuntimeException(
	                    "Record not found for REPORT_DATE: " + updatedEntity.getReportDate()));
...
throw new RuntimeException("❌ Error while updating SECA Summary fields", e);
	    ...
	    BRRS_M_SECA_Summary_Repo.save(existing); 
	    BRRS_M_SECA_Detail_Repo.save(existingDetail);
System.out.println("✅ SECA Summary and Detail updated and COMMITTED");

/*
 * // NOW PROCEDURE CAN SEE UPDATED DATA String oracleDate = new
 * SimpleDateFormat("dd-MM-yyyy") .format(updatedEntity.getReportDate())
 * .toUpperCase();
 * 
 * String sql = "BEGIN BRRS.BRRS_M_SECA_SUMMARY_PROCEDURE('" + oracleDate +
 * "'); END;"; jdbcTemplate.execute(sql);
 * 
...
//			System.out.println(type);
//			// 🔹 Archival branch
//			List<M_SECA_Archival_Detail_Entity> T1Dt1;
...
//		} else {
//			// 🔹 Current branch
//			List<M_SECA_Detail_Entity> T1Dt1;
//			if (rowId != null && columnId != null) {
...
//}
	...
	public byte[] BRRS_M_SECAExcel(String filename, String reportId, String fromdate, String todate, String currency,
        ...
        System.out.println("I am In BRRS_M_SECAExcel Method !!");
		// ARCHIVAL check
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
			...
			return getExcelM_SECAARCHIVAL(filename, reportId, fromdate, todate, currency, dtltype, type,format, version);
		}
		else if("RESUB".equalsIgnoreCase(type) && version != null)
		{
			...
			return getExcelM_SECARESUB(filename, reportId, fromdate, todate, currency, dtltype, type,format, version);
		}
...
//	public byte[] getM_SECADetailExcel(String filename, String fromdate, String todate, String currency,
//			   String dtltype, String type, String version) {
//try {
//logger.info("Generating Excel for M_SECA Details...");
...
//
//} catch (Exception e) {
//logger.error("Error generating M_SECA Excel", e);
//return new byte[0];
//}
//}
...
//	}
	...
	public List<Object> getM_SECAArchival() {
		...
		try {
			//M_SECAArchivallist = BRRS_M_SECA_Manual_Archival_Summary_Repo.getM_SECAarchival();
	...
	public List<Object[]> getM_SECAResub()
	{
		List<Object[]> M_SECAResub = new ArrayList<>();
		try {
			List<M_SECA_Resub_Summary_Entity> resub_Summary_Entities = BRRS_M_SECA_Resub_Summary_Repo.getdatabydateListWithVersion();
		  if(resub_Summary_Entities != null)
		  {
			for(M_SECA_Resub_Summary_Entity entity : resub_Summary_Entities)
			{
				M_SECAResub.add(new Object[] {entity.getReportDate(),entity.getReportVersion(),entity.getReportResubDate()});
			}
			System.out.println("Fetched " + M_SECAResub.size() + " record(s)");
		  }
		  else
		  {
			  System.err.println("The Resub SECA Data Is Not Found In DB");
		  }
			System.out.println("M_SECAResub Length = " + M_SECAResub.size());
			
		}
		catch(Exception e)
		{
			System.err.println("Error fetching M_SECA Resub data: " + e.getMessage());
			e.printStackTrace();
		}
		return M_SECAResub;
	}
...
public byte[] getExcelM_SECA_EMAIL(String filename, String reportId, String fromdate, String todate,
										   String currency, String dtltype, String type,String format ,BigDecimal version) throws Exception
{
	...
	if(dataList.isEmpty())
	{
		logger.warn("Service: No data found for M_SECA Email report. Returning empty result.");
		return new byte[0];
	}
	String templateDir = env.getProperty("output.exportpathtemp");
...
public byte[] getExcelM_SECARESUB_EMAIL(String filename, String reportId, String fromdate, String todate,
		   String currency, String dtltype, String type,String format ,BigDecimal version) throws Exception
{
	System.out.println("Here It Comes-1");
	logger.info("Service: Starting Email Excel generation process in memory.");
	...
	List<M_SECA_Resub_Summary_Entity> dataList = BRRS_M_SECA_Resub_Summary_Repo.getdatabydateListarchival(reportDate, version);
	if(dataList.isEmpty())
	{
		logger.warn("Service: No data found for M_SECA Email report. Returning empty result.");
		return new byte[0];
	     ...
	     ByteArrayOutputStream out = new ByteArrayOutputStream();  )			
	{
		...
		if (!dataList.isEmpty()) {
			for (int i = 0; i < dataList.size(); i++) {
				M_SECA_Resub_Summary_Entity record = dataList.get(i);				
				System.out.println("rownumber=" + startRow + i);
				Row row = sheet.getRow(startRow + i);
				if (row == null) {
					row = sheet.createRow(startRow + i);
...
//--------------------------------------------M-SECA-ARCHIVAL-EMAIL------------------------------------------------------------------
public byte[] getExcelM_SECAARCHIVAL_EMAIL(String filename, String reportId, String fromdate, String todate,
		   String currency, String dtltype, String type,String format ,BigDecimal version)throws Exception
{
	System.out.println("M_SECAARCHIVAL_EMAIL !!");
	logger.info("Service: Starting Email Excel generation process in memory.");
	
	List<M_SECA_Archival_Summary_Entity> dataList = BRRS_M_SECA_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate),version);
	if(dataList.isEmpty())
	{
		logger.warn("Service: No data found for M_SECA Email report. Returning empty result.");
		return new byte[0];
...
//-------------------------------------------------END--------------------------------------------------------------------------------
//--------------------------------------------M_SECARESUB-----------------------------------------------------------------------------
public byte[] getExcelM_SECARESUB(String filename, String reportId, String fromdate, String todate,
		   String currency, String dtltype, String type,String format ,BigDecimal version) throws Exception {
	
	logger.info("Service: Starting Excel generation process in memory.");
	
	List<M_SECA_Resub_Summary_Entity> dataList = BRRS_M_SECA_Resub_Summary_Repo
...
//// Get data
//Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
//List<M_SECA_Archival_Detail_Entity> reportData = BRRS_M_SECA_Archival_Detail_Repo.getdatabydateList(parsedToDate,version);
//
//if (reportData != null && !reportData.isEmpty()) {
//int rowIndex = 1;
//for (M_SECA_Archival_Detail_Entity item : reportData) {
//XSSFRow row = sheet.createRow(rowIndex++);
//
...
//}
//} else {
//logger.info("No data found for M_SECA — only header will be written.");
//}
//// Write to byte[]
//ByteArrayOutputStream bos = new ByteArrayOutputStream();
//workbook.write(bos);
