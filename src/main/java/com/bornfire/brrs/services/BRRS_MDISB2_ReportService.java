...
public class BRRS_MDISB2_ReportService {
	...
	public byte[] getMDISB2ARCHIVAL(String filename, String reportId, String fromdate, String todate,
	...
	public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
		try {
			...
			if (isChanged) {
				...
				TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronizationAdapter() {
					...
					public void afterCommit() {
						try {
							logger.info("Transaction committed — calling BRRS_MDISB2_SUMMARY_PROCEDURE({})",
									formattedDate);
							jdbcTemplate.update("BEGIN BRRS_MDISB2_SUMMARY_PROCEDURE(?); END;", formattedDate);
			...
			logger.error("Error updating MDISB2 record", e);
