...
public class RegulatoryReportServices {
	...
	public ModelAndView getReportView(String reportId, String reportDate, String fromdate, String todate,
		...
		case "M_INT_RATES_FCA":
			repsummary = brrs_m_int_rates_fca_reportservice.getM_INTRATESFCAView(reportId, fromdate, todate, currency,
					dtltype, pageable, type, version);
			break;
	...
	public byte[] getDownloadFile(String reportId, String filename, String asondate, String fromdate, String todate,
		...
		case "BDISB1":
			try {
				repfile = brrs_m_bdisb1_reportservice.getM_BDISB1Excel(filename, reportId, fromdate, todate, currency,
						dtltype, type, version);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
		...
		case "M_BOP":
			try {
				...
				repfile = BRRS_M_BOP_ReportService.getBRRS_M_BOPExcel(filename, reportId, fromdate, todate, currency,
						dtltype, type, version);
