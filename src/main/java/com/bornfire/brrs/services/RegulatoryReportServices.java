...
public class RegulatoryReportServices {
	...
	public ModelAndView getReportView(String reportId, String reportDate, String fromdate, String todate,
		...
		switch (reportId) {
			...
			case "M_INT_RATES_FCA":
				repsummary = BRRS_M_INT_RATES_FCA_ReportService.getINT_RATES_FCAView(reportId, fromdate,
						todate, currency, dtltype, pageable, type, version);
				break;

			case "M_INT_RATES_FCA_NEW":
				repsummary = BRRS_M_INT_RATES_FCA_NEW_ReportService.getINT_RATES_FCA_NEWView(reportId,
						fromdate, todate, currency, dtltype, pageable, type, version);
				break;
			...
			case "Q_STAFF":
				repsummary = BRRS_Q_STAFF_report_service.getQ_STAFFView(reportId, fromdate, todate,
						currency, dtltype, pageable, type, version);
				break;

					case "Q_STAFF_NEW":
				repsummary = BRRS_Q_STAFF_New_report_service.getQ_STAFF_NewView(reportId, fromdate, todate,
						currency, dtltype, pageable, type, version);
				break;
	...
	public ModelAndView getReportDetails(String reportId, String instanceCode, String asondate, String fromdate,
		...
		switch (reportId) {
			...
			case "M_LA1_NEW":
				repdetail = BRRS_M_LA1_reportservice_new.getM_LA1currentDtl(reportId, fromdate, todate, currency,
						dtltype,
						pageable, Filter, type, version);
				break;
	...
	// 			repdetail = BRRS_Q_STAFF_New_report_service.getQ_STAFF_NewcurrentDtl(reportId,
	// 					fromdate, todate, currency, dtltype, pageable, Filter, type, version);
	// 			break;
			case "BDISB1":
	...
	public byte[] getDownloadFile(String reportId, String filename, String asondate, String fromdate, String todate,
		...
		switch (reportId) {
			...
			case "Q_STAFF":
				try {
					repfile = BRRS_Q_STAFF_report_service.BRRS_Q_STAFFExcel(filename, reportId, fromdate,
							todate, currency, dtltype, type, version);
				} catch (Exception e) {
					e.printStackTrace();
				}
				break;
					...
					case "Q_STAFF_NEW":
				try {
					repfile = BRRS_Q_STAFF_New_report_service.BRRS_Q_STAFF_NewExcel(filename, reportId, fromdate,
							todate, currency, dtltype, type, version);
				} catch (Exception e) {
					e.printStackTrace();
				}
			...
			case "M_INT_RATES":
				try {
					repfile = brrs_m_int_rates_reportservice.getM_INTRATESExcel(filename, reportId,
							fromdate, todate, currency, dtltype, type, version);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
			...
			case "M_INT_RATES_FCA":
				try {
					repfile = BRRS_M_INT_RATES_FCA_ReportService.getM_INTRATESFCAExcel(filename, reportId,
							fromdate, todate, currency, dtltype, type, version);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
			...
			case "M_INT_RATES_FCA_NEW":
				try {
					...
					repfile = BRRS_M_INT_RATES_FCA_NEW_ReportService.getM_INTRATESFCANEWExcel(filename, reportId,
							fromdate, todate, currency, dtltype, type, version);
				} catch (Exception e) {
					// TODO }Auto-generated catch block
					e.printStackTrace();
			...
			case "M_SRWA_12A_New":
				try {
					...
					repfile = brrs_M_SRWA_12A_New_reportservice.getM_SRWA_12A_NewExcel(filename, reportId, fromdate,
							todate,
							currency, dtltype, type, version);
				} catch (Exception e) { // TODO Auto-generated catch block
					e.printStackTrace();
