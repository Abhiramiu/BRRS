...
public class RegulatoryReportServices {
	...
	public ModelAndView getReportView(String reportId, String reportDate, String fromdate, String todate,
		...
		switch (reportId) {
			...
			case "NSFR":
				repsummary = BRRS_NSFR_ReportService.getNSFRView(reportId, fromdate, todate, currency,
						dtltype,
						pageable, type, version);
	...
	public ModelAndView getReportDetails(String reportId, String instanceCode, String asondate, String fromdate,
		...
		switch (reportId) {
			...
			case "Recon_Of_FS":
				repdetail = BRRS_RECON_OF_FS_ReportService.getBRRS_Recon_Of_FScurrentDtl(reportId, fromdate,
						todate, currency,
						dtltype,
						pageable, Filter, type, version);
				break;
		...
		switch (reportId) {
			...
			case "SCH_17":
				try {
					...
					repfile = brrs_sch_17_reportservice.getSCH_17Excel(filename, reportId, fromdate,
							todate, currency,
							dtltype, type, version);
				} catch (Exception e) {
					// TODO Auto-generated catch block
			...
			case "FORMAT_II":
				try {
					...
					repfile = brrs_format_II_reportservice.getFORMAT_IIExcel(filename, reportId, fromdate,
							todate, currency,
							dtltype, type, version);
				} catch (Exception e) {
					// TODO Auto-generated catch block
			...
			case "NSFR":
				try {
					repfile = BRRS_NSFR_ReportService.getNSFRExcel(filename, reportId,
							fromdate,
							todate,
							currency, dtltype, type, version);
				} catch (Exception e) {
	...
	public void generateReportAsync(String jobId, String filename, String fromdate, String todate, String dtltype,
		...
		if (filename.equals("MSFinP2Detail")) {
			...
			fileData = BRRS_RECON_OF_FS_ReportService.BRRS_Recon_Of_FSDetailExcel(filename, fromdate, todate,
					currency, dtltype, type, version);
		}
			...
			fileData = brrs_format_II_reportservice.getFORMAT_IIDetailExcel(filename, fromdate, todate,
					currency,
					dtltype, type, version);
		}
