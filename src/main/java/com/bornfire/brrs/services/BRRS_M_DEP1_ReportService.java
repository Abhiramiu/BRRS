	...
	public byte[] BRRS_M_DEP1Excel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		try (InputStream templateInputStream = Files.newInputStream(templatePath);
			...
			if (attrs != null) {
				...
				auditService.createBusinessAudit(userid, "DOWNLOAD", "M_DEP1 SUMMARY", null, "BRRS_M_DEP1_SUMMARYTABLE");
			}
...
// Write the final workbook content to the in-memory stream.
			...
			if (attrs != null) {
				HttpServletRequest request = attrs.getRequest();
				String userid = (String) request.getSession().getAttribute("USERID");
				auditService.createBusinessAudit(userid, "DOWNLOAD", "M_DEP1 ARCHIVAL SUMMARY", null, "BRRS_M_DEP1_ARCHIVALTABLE_SUMMARY");
			}
			return out.toByteArray();
		}
	}
	...
	public ModelAndView getViewOrEditPage(String acctNo, String formMode) {
	    ...
	    if (acctNo != null) {
	    	M_DEP1_Detail_Entity la1Entity = M_DEP1_Detail_Repo.findByAcctnumber(acctNo);
