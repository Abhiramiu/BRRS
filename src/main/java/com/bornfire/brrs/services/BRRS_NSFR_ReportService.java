...
//import com.bornfire.brrs.entities.NSFR_Manual_Summary_Entity;
//import com.bornfire.brrs.entities.NSFR_Manual_Archival_Summary_Entity;
//import com.bornfire.brrs.entities.BRRS_NSFR_Manual_Summary_Repo;
//import com.bornfire.brrs.entities.BRRS_NSFR_Manual_Archival_Summary_Repo;
...
public class BRRS_NSFR_ReportService {
	...
	@Autowired
	BRRS_NSFR_Detail_Repo BRRS_NSFR_Detail_Repo;

	@Autowired
	BRRS_NSFR_Summary_Repo BRRS_NSFR_Summary_Repo;

//	@Autowired
//	BRRS_NSFR_Manual_Summary_Repo BRRS_NSFR_Manual_Summary_Repo;
//

	@Autowired
	BRRS_NSFR_Archival_Detail_Repo BRRS_NSFR_Archival_Detail_Repo;

	@Autowired
	BRRS_NSFR_Archival_Summary_Repo BRRS_NSFR_Archival_Summary_Repo;

//	@Autowired
//	BRRS_NSFR_Manual_Archival_Summary_Repo BRRS_NSFR_Manual_Archival_Summary_Repo;
//
...
//		int startItem = currentPage * pageSize;
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<NSFR_Archival_Summary_Entity> T1Master = new ArrayList<NSFR_Archival_Summary_Entity>();
//			List<NSFR_Manual_Archival_Summary_Entity> T2Master = new ArrayList<NSFR_Manual_Archival_Summary_Entity>();
			...
			try {
				...
				T1Master = BRRS_NSFR_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
//				T2Master = BRRS_NSFR_Manual_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
...
//			List<NSFR_Manual_Summary_Entity> T2Master = new ArrayList<NSFR_Manual_Summary_Entity>();
			...
			try {
				...
				// ", BRF1_REPORT_ENTITY.class)
				// .setParameter(1, df.parse(todate)).getResultList();
				T1Master = BRRS_NSFR_Summary_Repo.getdatabydateList(dateformat.parse(todate));
//				T2Master = BRRS_NSFR_Manual_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
//			// 🔹 Archival branch
//			List<NSFR_Archival_Detail_Entity> T1Dt1;
//			if (rowId != null && columnId != null) {
//				T1Dt1 = BRRS_NSFR_Archival_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate, version);
//			} else {
//				T1Dt1 = BRRS_NSFR_Archival_Detail_Repo.getdatabydateList(parsedDate, version);					
//			}
//
...
//		} else {
//			// 🔹 Current branch
//			List<NSFR_Detail_Entity> T1Dt1;
//			if (rowId != null && columnId != null) {
//				T1Dt1 = BRRS_NSFR_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate);
//			} else {
//				T1Dt1 = BRRS_NSFR_Detail_Repo.getdatabydateList(parsedDate);
//				totalPages = BRRS_NSFR_Detail_Repo.getdatacount(parsedDate);
...
List<NSFR_Detail_Entity> reportData = BRRS_NSFR_Detail_Repo.getdatabydateList(parsedToDate);
...
List<NSFR_Archival_Summary_Entity> T1Master =
BRRS_NSFR_Archival_Summary_Repo.getdatabydateListarchival(reportDate, version);
...
//Default (LIVE) case
List<NSFR_Summary_Entity> dataList1 = BRRS_NSFR_Summary_Repo.getdatabydateList(reportDate);
...
return out.toByteArray();
	...
	public List<Object> getNSFRArchival() {
		List<Object> NSFRArchivallist = new ArrayList<>();
		try {
			NSFRArchivallist = BRRS_NSFR_Archival_Summary_Repo.getNSFRarchival();
//			NSFRArchivallist = BRRS_NSFR_Manual_Archival_Summary_Repo.getNSFRarchival();
			System.out.println("countser" + NSFRArchivallist.size());
		} catch (Exception e) {
			// Log the exception
...
// Get data
Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
List<NSFR_Archival_Detail_Entity> reportData = BRRS_NSFR_Archival_Detail_Repo.getdatabydateList(parsedToDate,version);
...
return new byte[0];
	...
	public byte[] getExcelNSFRARCHIVAL(String filename, String reportId, String fromdate, String todate,
		...
		List<NSFR_Archival_Summary_Entity> dataList = BRRS_NSFR_Archival_Summary_Repo
...
if (record.getR60_TOTAL_AMOUNT_BOB() != null) {
 ...
 cell1.setCellStyle(textStyle);
	...
	public ModelAndView getViewOrEditPage(String acctNo, String formMode) {
	    ...
	    if (acctNo != null) {
	    	NSFR_Detail_Entity NSFREntity = BRRS_NSFR_Detail_Repo.findByAcctnumber(acctNo);
	...
	public ModelAndView updateDetailEdit(String acctNo, String formMode) {
	    ...
	    if (acctNo != null) {
	        NSFR_Detail_Entity la1Entity = BRRS_NSFR_Detail_Repo.findByAcctnumber(acctNo);
	...
	public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
	    try {
	        ...
	        NSFR_Detail_Entity existing = BRRS_NSFR_Detail_Repo.findByAcctnumber(acctNo);
	        if (existing == null) {
