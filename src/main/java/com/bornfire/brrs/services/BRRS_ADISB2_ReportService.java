...
//RESUB check
			...
			List<ADISB2_Archival_Summary_Entity> T1Master = ADISB2_Archival_Summary_Repo
...
// Write the final workbook content to the in-memory stream.
	...
	public List<Object[]> getADISB2Archival() {
		...
		try {
			List<ADISB2_Archival_Summary_Entity> repoData = ADISB2_Archival_Summary_Repo.getdatabydateListWithVersion();
...
// Get data
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<ADISB2_Archival_Detail_Entity> reportData = ADISB2_Archival_Detail_Repo.getdatabydateList(parsedToDate,
					version);
