...
public class BRRS_M_INT_RATES_FCA_NEW_ReportService {
	...
	public ModelAndView getINT_RATES_FCA_NEWView(String reportId, String fromdate, String todate, String currency,
	...
	public ModelAndView getM_INT_RATES_FCA_NEWcurrentDtl(String reportId, String fromdate, String todate,
	...
	public void updateDetailFromForm(Date reportDate, Map<String, String> params) {
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			List<M_INT_RATES_FCA_NEW_Detail_Entity> rows = M_INT_RATES_FCA_NEW_Detail_Repo
...
//	}
	...
	public byte[] getM_INTRATESFCANEWExcel(String filename, String reportId, String fromdate, String todate,
		...
		// RESUB check
			...
			return BRRS_M_INT_RATES_FCA_NEWResubExcel(filename, reportId, fromdate, todate, currency, dtltype, type,
					version);
		}

		// Default (LIVE) case
		List<M_INT_RATES_FCA_NEW_Summary_Entity> dataList = M_INT_RATES_FCA_NEW_Summary_Repo
...
/// RESUB VIEW
	public List<Object[]> getM_INT_RATES_FCA_NEWResub() {
		...
		try {
			List<M_INT_RATES_FCA_NEW_Archival_Summary_Entity> latestArchivalList = M_INT_RATES_FCA_NEW_Archival_Summary_Repo
...
//Archival View
	/*
	 * public List<Object[]> getM_INT_RATES_FCA_NEWArchival() { List<Object[]>
	 * archivalList = new ArrayList<>();
	 * 
	 * try { List<M_INT_RATES_FCA_NEW_Archival_Summary_Entity> repoData =
	 * M_INT_RATES_FCA_NEW_Archival_Summary_Repo .getdatabydateListWithVersionAll();
	 * 
	 * if (repoData != null && !repoData.isEmpty()) { for
	 * (M_INT_RATES_FCA_NEW_Archival_Summary_Entity entity : repoData) { Object[]
	 ...
	 * 
	 * } catch (Exception e) {
	 * System.err.println("Error fetching M_INT_RATES_FCA_NEW Archival data: " +
	 ...
	 * updateReportReSub(M_INT_RATES_FCA_NEW_Summary_Entity updatedEntity) {
	 * 
	 ...
	 * 
	 * boolean exists = M_INT_RATES_FCA_NEW_Archival_Summary_Repo
	 ...
	 * =========================================================
	 * M_INT_RATES_FCA_NEW_Archival_Summary_Entity archivalEntity = new
	 * M_INT_RATES_FCA_NEW_Archival_Summary_Entity();
	 * 
...
/// Downloaded for Archival & Resub
	public byte[] BRRS_M_INT_RATES_FCA_NEWResubExcel(String filename, String reportId, String fromdate, String todate,
			String currency, String dtltype, String type, BigDecimal version) throws Exception {
		...
		List<M_INT_RATES_FCA_NEW_Archival_Summary_Entity> dataList = M_INT_RATES_FCA_NEW_Archival_Summary_Repo
				.getdatabydateListarchival(dateformat.parse(todate), version);
...
// --- End of Style Definitions ---	
	...
	public byte[] getM_INTRATESFCANEWDetailExcel(String filename, String fromdate, String todate, String currency,
		...
		try {
			...
			List<M_INT_RATES_FCA_NEW_Detail_Entity> reportData = M_INT_RATES_FCA_NEW_Detail_Repo
	...
	public byte[] getDetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency,
		...
		try {
			...
			// ================= DATA FETCH =================
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<M_INT_RATES_FCA_NEW_Archival_Detail_Entity> reportData = M_INT_RATES_FCA_NEW_Archival_Detail_Repo
	...
	public List<Object> getM_INT_RATES_FCA_NEWArchival() {
		List<Object> M_INT_RATES_FCANEWArchivallist = new ArrayList<>();
		try {
			M_INT_RATES_FCANEWArchivallist = M_INT_RATES_FCA_NEW_Archival_Summary_Repo.getM_INTRATESFCANEWarchival();
		
		
			System.out.println("countser" + M_INT_RATES_FCANEWArchivallist.size());
			
		} catch (Exception e) {
			// Log the exception
			System.err.println("Error fetching M_INT_RATES_FCANEWArchivallist Archival data: " + e.getMessage());
			e.printStackTrace();

			// Optionally, you can rethrow it or return empty list
			// throw new RuntimeException("Failed to fetch data", e);
		}
		return M_INT_RATES_FCANEWArchivallist;
	}
