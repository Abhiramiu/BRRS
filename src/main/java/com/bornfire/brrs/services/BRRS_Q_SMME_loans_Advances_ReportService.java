...
public class BRRS_Q_SMME_loans_Advances_ReportService<BBRS_Q_SMME_Detail_Repo> {
	...
	public byte[] getQ_SMMEExcel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		// Fetch data
		List<Q_SMME_loans_Advances_Summary_Entity> dataList = q_SMME_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
public byte[] getDetailExcelARCHIVAL(String filename,
    ...
    try {
       ...
       // Date parsedToDate = new SimpleDateFormat("dd-MM-yyyy").parse(todate); // ✅ match with controller
        List<Q_SMME_loans_Advances_Archival_Detail_Entity> reportData =
