...
public class BRRS_M_GMIRT_ReportService {
		...
		try {
			...
			// ---------- CASE 3: NORMAL ----------
					...
					try {
						...
						System.out.println("T1Master size for GMIRT " + T1Master.size());
				 ...
				 if ("detail".equalsIgnoreCase(dtltype)) {
					 Date d1 = dateformat.parse(todate);
			            ...
			            if (version != null) {
			                ...
			                List<M_GMIRT_Archival_Detail_Entity> T1Master =
			                		m_gmirt_Archival_Detail_Repo
			            ...
			            // DETAIL + NORMAL
			                ...
			                List<M_GMIRT_Detail_Entity> T1Master =
			                		m_gmirt_Detail_Repo
	...
	public byte[] getM_GMIRTExcel(String filename, String reportId, String fromdate, String todate, String currency,
        ...
        if ("email".equalsIgnoreCase(type)  && version == null) {
           ...
           logger.info("Service: Generating Email report for version {}", version);
           return BRRS_M_GMIRTARCHIVALEmailExcel(filename, reportId, fromdate, todate,
...
// Write the final workbook content to the in-memory stream.
	...
	public byte[] BRRS_M_GMIRTEmailExcel(String filename, String reportId, String fromdate, String todate, String currency,
			String dtltype, String type, BigDecimal version) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");
...
// Write the final workbook content to the in-memory stream.
	...
	public List<Object> getM_GMIRTArchival() {
		...
		try {
			...
			// Log the exception
			System.err.println("Error fetching M_GMIRTArchivallist Archival data: " + e.getMessage());
			e.printStackTrace();
...
// Write to byte[]
	...
	*/
	...
	public void updateReport(M_GMIRT_Summary_Entity updatedEntity) {
	    ...
	    try {
	        ...
	        for (int i = 9; i <= 12; i++) {
	            ...
	            String[] fields = {"currency", "pula", "usd", "zar", "gbp", "euro", "jpy",
	                    "rupee", "renminbi", "other", "tot_cap_req"};
	...
	public void updateDetail(M_GMIRT_Detail_Entity updatedEntity) {
	    ...
	    M_GMIRT_Detail_Entity existing = m_gmirt_Detail_Repo.findById(updatedEntity.getReport_date())
	            .orElseThrow(() -> new RuntimeException(
	                    "Record not found for REPORT_DATE: " + updatedEntity.getReport_date()));
