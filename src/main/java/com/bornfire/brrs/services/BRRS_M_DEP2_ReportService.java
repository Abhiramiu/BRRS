...
public class BRRS_M_DEP2_ReportService {
	...
	// ------------------------------
	public ModelAndView getM_DEP2View(String reportId, String fromdate, String todate, String currency, String dtltype,
...
// Get data
			...
			List<M_DEP2_Detail_Entity> reportData = jdbcTemplate.query(
					"select * from BRRS_M_DEP2_DETAILTABLE where REPORT_DATE = ?",
...
// Write the final workbook content to the in-memory stream.
	...
	@Entity
	@Table(name = "BRRS_M_DEP2_SUMMARYTABLE")
	// ------------------------------
	// ENTITY: BRRS_M_DEP2_SUMMARYTABLE
	// ------------------------------
	public static class M_DEP2_Summary_Entity {
	...
	// ------------------------------
	// ENTITY: BRRS_M_DEP2_DETAILTABLE
	// ------------------------------
	...
	@Entity
	@Table(name = "BRRS_M_DEP2_ARCHIVALTABLE_SUMMARY")
	// ------------------------------
	// ENTITY: BRRS_M_DEP2_ARCHIVALTABLE_SUMMARY
	// ------------------------------
	public static class M_DEP2_Archival_Summary_Entity {
	...
	// ------------------------------
	// ENTITY: BRRS_M_DEP2_ARCHIVALTABLE_DETAIL
	// ------------------------------
