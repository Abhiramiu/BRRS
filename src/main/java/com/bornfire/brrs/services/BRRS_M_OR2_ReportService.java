...
public class BRRS_M_OR2_ReportService {
	...
	public ModelAndView getBRRS_M_OR2view(
	        String reportId,
	        String fromdate,
	        String todate,
	        String currency,
	    ...
	    try {
	        ...
	        // ---------- CASE 3: NORMAL ----------
	            ...
	            List<M_OR2_Summary_Entity> T1Master =
	                    M_OR2_Summary_Repo.getdatabydateList(dateformat.parse(todate));
	            mv.addObject("displaymode", "summary");
...
//	
	...
	public byte[] getM_OR2Excel(String filename, String reportId, String fromdate, String todate, String currency,
        ...
        if ("ARCHIVAL".equalsIgnoreCase(type) && version != null) {
            ...
            return getExcelM_OR2ARCHIVAL(filename, reportId, fromdate, todate,
        ...
        // Email check
         if ("email".equalsIgnoreCase(type)  && version == null) {
            ...
            logger.info("Service: Generating Email report for version {}", version);
            return BRRS_M_OR2ARCHIVALEmailExcel(filename, reportId, fromdate, todate,
                    currency, dtltype, type, version);

        }

	    /* ===================== NORMAL ===================== */
	    List<M_OR2_Summary_Entity> dataList =
	            M_OR2_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
public byte[] BRRS_M_OR2EmailExcel(String filename, String reportId, String fromdate, String todate,
		...
		if (dataList.isEmpty()) {
			logger.warn("Service: No data found for M_OR2_email report. Returning empty result.");
			return new byte[0];
		}
...
public byte[] BRRS_M_OR2ARCHIVALEmailExcel(String filename, String reportId, String fromdate, String todate,
	...
	if (dataList.isEmpty()) {
		logger.warn("Service: No data found for M_OR2_email_ARCHIVAL report. Returning empty result.");
		return new byte[0];
	}
...
public List<Object> getM_OR2Archival() {
	...
	try {
		M_OR2Archivallist = M_OR2_Archival_Summary_Repo.getM_OR2_archival();
