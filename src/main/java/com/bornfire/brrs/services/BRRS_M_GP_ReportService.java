...
public class BRRS_M_GP_ReportService {
	...
	@Autowired
	BRRS_M_GP_Archival_Summary_Repo BRRS_M_GP_Archival_Summary_Repo;

	SimpleDateFormat dateformat = new SimpleDateFormat("dd-MMM-yyyy");
	public ModelAndView getM_GPView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable,String type, String version) {
System.out.println("Entered service method M_GP......................");
		...
		int startItem = currentPage * pageSize;	
			...
			List<M_GP_Archival_Summary_Entity> T1Master = new ArrayList<M_GP_Archival_Summary_Entity>();
			System.out.println(version);
			try {
				Date d1 = dateformat.parse(todate);

				T1Master = BRRS_M_GP_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
		...
		List<M_GP_Summary_Entity> T1Master = new ArrayList<M_GP_Summary_Entity>();
		try {
			Date d1 = dateformat.parse(todate);
			
			 T1Master=BRRS_M_GP_Summary_Repo.getdatabydateList(dateformat.parse(todate));
	...
	public List<Object> getM_GPArchival() {
		...
		try {
			M_GPArchivallist = BRRS_M_GP_Archival_Summary_Repo.getM_GParchival();
	...
	public void updateReport(M_GP_Summary_Entity Entity) {
	    ...
	    M_GP_Summary_Entity existing = BRRS_M_GP_Summary_Repo.findById(Entity.getREPORT_DATE())
	...
	public byte[] getM_GPExcel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype,String type,String version) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");
		System.out.println(type);
		System.out.println(version);
		if (type.equals("ARCHIVAL") & version != null) {
			byte[] ARCHIVALreport = getExcelM_GPARCHIVAL(filename, reportId, fromdate, todate, currency, dtltype, type,
					version);
...
return out.toByteArray();
	...
	public byte[] getExcelM_GPARCHIVAL(String filename,String reportId, String fromdate, String todate, String currency, String dtltype,String type,String version) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");
		System.out.println(type);
		System.out.println(version);
		
		List<M_GP_Archival_Summary_Entity> dataList =BRRS_M_GP_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version) ;
