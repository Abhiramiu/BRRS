...
import com.bornfire.brrs.entities.BRRS_TIER_1_2_CFS_Summary_Repo;
import com.bornfire.brrs.entities.TIER_1_2_CFS_Archival_Detail_Entity;
import com.bornfire.brrs.entities.TIER_1_2_CFS_Archival_Summary_Entity;
import com.bornfire.brrs.entities.TIER_1_2_CFS_Detail_Entity;
import com.bornfire.brrs.entities.TIER_1_2_CFS_Summary_Entity;
//import com.bornfire.brrs.entities.TIER_1_2_CFS_Manual_Summary_Entity;
//import com.bornfire.brrs.entities.TIER_1_2_CFS_Manual_Archival_Summary_Entity;
//import com.bornfire.brrs.entities.BRRS_TIER_1_2_CFS_Manual_Summary_Repo;
//import com.bornfire.brrs.entities.BRRS_TIER_1_2_CFS_Manual_Archival_Summary_Repo;
...
public class BRRS_TIER_1_2_CFS_ReportService {
	...
	@Autowired
	BRRS_TIER_1_2_CFS_Detail_Repo BRRS_TIER_1_2_CFS_Detail_Repo;

	@Autowired
	BRRS_TIER_1_2_CFS_Summary_Repo BRRS_TIER_1_2_CFS_Summary_Repo;

//	@Autowired
//	BRRS_TIER_1_2_CFS_Manual_Summary_Repo BRRS_TIER_1_2_CFS_Manual_Summary_Repo;
//

	@Autowired
	BRRS_TIER_1_2_CFS_Archival_Detail_Repo BRRS_TIER_1_2_CFS_Archival_Detail_Repo;

	@Autowired
	BRRS_TIER_1_2_CFS_Archival_Summary_Repo BRRS_TIER_1_2_CFS_Archival_Summary_Repo;

//	@Autowired
//	BRRS_TIER_1_2_CFS_Manual_Archival_Summary_Repo BRRS_TIER_1_2_CFS_Manual_Archival_Summary_Repo;
//
...
//		int startItem = currentPage * pageSize;
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<TIER_1_2_CFS_Archival_Summary_Entity> T1Master = new ArrayList<TIER_1_2_CFS_Archival_Summary_Entity>();
//			List<TIER_1_2_CFS_Manual_Archival_Summary_Entity> T2Master = new ArrayList<TIER_1_2_CFS_Manual_Archival_Summary_Entity>();
			...
			try {
				...
				T1Master = BRRS_TIER_1_2_CFS_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
//				T2Master = BRRS_TIER_1_2_CFS_Manual_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
...
//			mv.addObject("reportsummary1", T2Master);
			...
			List<TIER_1_2_CFS_Summary_Entity> T1Master = new ArrayList<TIER_1_2_CFS_Summary_Entity>();
//			List<TIER_1_2_CFS_Manual_Summary_Entity> T2Master = new ArrayList<TIER_1_2_CFS_Manual_Summary_Entity>();
			...
			try {
				...
				// ", BRF1_REPORT_ENTITY.class)
				// .setParameter(1, df.parse(todate)).getResultList();
				T1Master = BRRS_TIER_1_2_CFS_Summary_Repo.getdatabydateList(dateformat.parse(todate));
//				T2Master = BRRS_TIER_1_2_CFS_Manual_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
//	public ModelAndView getTIER_1_2_CFScurrentDtl(String reportId, String fromdate, String todate, String currency,
...
//			// 🔹 Archival branch
//			List<TIER_1_2_CFS_Archival_Detail_Entity> T1Dt1;
//			if (rowId != null && columnId != null) {
//				T1Dt1 = BRRS_TIER_1_2_CFS_Archival_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate, version);
//			} else {
//				T1Dt1 = BRRS_TIER_1_2_CFS_Archival_Detail_Repo.getdatabydateList(parsedDate, version);					
//			}
//
...
//		} else {
//			// 🔹 Current branch
//			List<TIER_1_2_CFS_Detail_Entity> T1Dt1;
//			if (rowId != null && columnId != null) {
//				T1Dt1 = BRRS_TIER_1_2_CFS_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate);
//			} else {
//				T1Dt1 = BRRS_TIER_1_2_CFS_Detail_Repo.getdatabydateList(parsedDate);
//				totalPages = BRRS_TIER_1_2_CFS_Detail_Repo.getdatacount(parsedDate);
...
//	public void updateReport(TIER_1_2_CFS_Manual_Summary_Entity updatedEntity) {
//	    System.out.println("Came to services1");
//	    System.out.println("Report Date: " + updatedEntity.getReport_date());
//
//	    TIER_1_2_CFS_Manual_Summary_Entity existing = BRRS_TIER_1_2_CFS_Manual_Summary_Repo.findById(updatedEntity.getReport_date())
...
//
//	                    Method getter = TIER_1_2_CFS_Manual_Summary_Entity.class.getMethod(getterName);
//	                    Method setter = TIER_1_2_CFS_Manual_Summary_Entity.class.getMethod(setterName, getter.getReturnType());
//
...
//	        BRRS_TIER_1_2_CFS_Manual_Summary_Repo.save(existing);
//
//	    } catch (Exception e) {
...
//	}
	...
	public byte[] getTIER_1_2_CFSDetailExcel(String filename, String fromdate, String todate, String currency,
...
XSSFSheet sheet = workbook.createSheet("TIER_1_2_CFSDetail");
...
List<TIER_1_2_CFS_Detail_Entity> reportData = BRRS_TIER_1_2_CFS_Detail_Repo.getdatabydateList(parsedToDate);
...
List<TIER_1_2_CFS_Archival_Summary_Entity> T1Master =
BRRS_TIER_1_2_CFS_Archival_Summary_Repo.getdatabydateListarchival(reportDate, version);
...
//Default (LIVE) case
List<TIER_1_2_CFS_Summary_Entity> dataList1 = BRRS_TIER_1_2_CFS_Summary_Repo.getdatabydateList(reportDate);
...
TIER_1_2_CFS_Summary_Entity record = dataList1.get(i);
...
//			TIER_1_2_CFSArchivallist = BRRS_TIER_1_2_CFS_Manual_Archival_Summary_Repo.getTIER_1_2_CFSarchival();
	...
	public byte[] getDetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency,
			 String dtltype, String type, String version) {
try {
logger.info("Generating Excel for BRRS_TIER_1_2_CFS ARCHIVAL Details...");
System.out.println("came to Detail download service");
if (type.equals("ARCHIVAL") & version != null) {
...
// Get data
Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
List<TIER_1_2_CFS_Archival_Detail_Entity> reportData = BRRS_TIER_1_2_CFS_Archival_Detail_Repo.getdatabydateList(parsedToDate,version);
...
return new byte[0];
	...
	public byte[] getExcelTIER_1_2_CFSARCHIVAL(String filename, String reportId, String fromdate, String todate,
		...
		List<TIER_1_2_CFS_Archival_Summary_Entity> dataList = BRRS_TIER_1_2_CFS_Archival_Summary_Repo
	...
	public ModelAndView getViewOrEditPage(String acctNo, String formMode) {
	    ModelAndView mv = new ModelAndView("BRRS/TIER_1_2_CFS"); // ✅ match the report name
	    System.out.println("Hello");
	    if (acctNo != null) {
	    	TIER_1_2_CFS_Detail_Entity TIER_1_2_CFSEntity = BRRS_TIER_1_2_CFS_Detail_Repo.findByAcctnumber(acctNo);
	        ...
	        mv.addObject("Data", TIER_1_2_CFSEntity);
	    }
	...
	public ModelAndView updateDetailEdit(String acctNo, String formMode) {
	    ...
	    if (acctNo != null) {
	        TIER_1_2_CFS_Detail_Entity la1Entity = BRRS_TIER_1_2_CFS_Detail_Repo.findByAcctnumber(acctNo);
	...
	public ResponseEntity<?> updateDetailEdit(HttpServletRequest request) {
	    try {
	        ...
	        TIER_1_2_CFS_Detail_Entity existing = BRRS_TIER_1_2_CFS_Detail_Repo.findByAcctnumber(acctNo);
	        if (existing == null) {
	        ...
	        if (isChanged) {
	        	BRRS_TIER_1_2_CFS_Detail_Repo.save(existing);
