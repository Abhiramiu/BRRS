...
//	}
	...
	public byte[] getM_INTRATESFCAExcel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype , String type ,
		...
		List<M_INT_RATES_FCA_Archival_Summary_Entity> T1Master =
				M_INT_RATES_FCA_Archival_Summary_Repo.getdatabydateListarchival(reportDate, version);

		// Generate Excel for RESUB
		return BRRS_M_INT_RATES_FCAResubExcel(filename, reportId, fromdate, todate, currency, dtltype, type, version);
		}
...
public byte[] BRRS_M_INT_RATES_FCAResubExcel(String filename, String reportId, String fromdate,
...
List<M_INT_RATES_FCA_Archival_Summary_Entity> dataList =
M_INT_RATES_FCA_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
