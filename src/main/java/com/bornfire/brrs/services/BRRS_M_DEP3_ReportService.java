...
public class BRRS_M_DEP3_ReportService {
	...
	public ModelAndView getM_DEP3currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		try {
			...
			if ("ARCHIVAL".equals(type) && version != null) {
				...
				if (reportLable != null && reportAddlCriteria_1 != null) {
					T1Dt1 = BRRS_M_DEP3_Detail_Repo.GetDataByRowIdAndColumnId(reportLable, reportAddlCriteria_1,
							parsedDate);
				} else {
	...
	public void updateReport(M_DEP3_Summary_Entity updatedEntity) {
		...
		try {
			...
			BRRS_M_DEP3_Summary_Repo.save(existing);
...
// Get data
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<M_DEP3_Archival_Detail_Entity> reportData = BRRS_M_DEP3_Archival_Detail_Repo
...
// Write to byte[]
	...
	public List<Object[]> getM_DEP3Resub() {
		...
		try {
			List<M_DEP3_Archival_Summary_Entity> latestArchivalList = BRRS_M_DEP3_Archival_Summary_Repo
...
//	// Archival View
	public List<Object[]> getM_DEP3Archival() {
		...
		try {
			List<M_DEP3_Archival_Summary_Entity> repoData = BRRS_M_DEP3_Archival_Summary_Repo
					.getdatabydateListWithVersion();
...
//			}
			...
			if ("email".equalsIgnoreCase(format) && version == null) {
				...
				List<M_DEP3_Summary_Entity> dataList = BRRS_M_DEP3_Summary_Repo
