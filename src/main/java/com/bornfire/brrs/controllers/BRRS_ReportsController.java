...
import com.bornfire.brrs.services.BRRS_FSI_ReportService;
...
import com.bornfire.brrs.services.BRRS_M_I_S_CA_ReportService.M_I_S_CA_Summary_Entity;
...
import com.bornfire.brrs.services.BRRS_M_OR1_ReportService.M_OR1_Summary_Entity;
import com.bornfire.brrs.services.BRRS_M_OR2_ReportService;
import com.bornfire.brrs.services.BRRS_M_PD_ReportService;
import com.bornfire.brrs.services.BRRS_M_PD_ReportService.M_PD_Manual_Summary_Entity;
...
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity1;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity2;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity3;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity4;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity5;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity6;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity7;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity8;
import com.bornfire.brrs.services.BRRS_M_RPD_ReportService.M_RPD_Summary_Entity9;
...
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity1;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity2;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity3;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity4;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity5;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity6;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity7;
import com.bornfire.brrs.services.BRRS_M_SRWA_12B_ReportService.M_SRWA_12B_Summary_Entity8;
...
import com.bornfire.brrs.services.BRRS_M_SRWA_12E_ReportService;
...
import com.bornfire.brrs.services.BRRS_M_TOP_100_BORROWER_ReportService.M_TOP_100_BORROWER_Manual_Summary_Entity1;
import com.bornfire.brrs.services.BRRS_M_TOP_100_BORROWER_ReportService.M_TOP_100_BORROWER_Manual_Summary_Entity2;
...
public class BRRS_ReportsController {
	...
	@RequestMapping(value = "/UNCResubupdateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReportReSub(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute M_UNCONS_INVEST_Resub_Summary_Entity request,
		...
		try {
			...
			UNCreportService.updateResubReport(request);
	...
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BRRS_M_SRWA_12C_ReportService.M_SRWA_12C_Summary_Entity request) {
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BRRS_M_SRWA_12C_ReportService.M_SRWA_12C_RESUB_Summary_Entity request,
			HttpServletRequest req) {
	...
	@RequestMapping(value = "/M_SRWA_12GupdateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAllReports(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute BRRS_M_SRWA_12G_ReportService.M_SRWA_12G_Summary_Entity request) {
	...
	public ResponseEntity<String> updateReportReSub(
			...
			@ModelAttribute BRRS_M_SRWA_12G_ReportService.M_SRWA_12G_Resub_Summary_Entity request,

			HttpServletRequest req) {

		try {

			System.out.println("Came to M_SRWA_12G Resub Controller");
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body("M_SRWA_12G Resubmission Update Failed : " + e.getMessage());
		}
	}
...
//	}
	...
	@Autowired
	BRRS_M_OR1_ReportService M_OR1_service;

	@RequestMapping(value = "/M_OR1updateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAllReports(
		...
		try {
			...
			M_OR1_service.updateReport(request1);
	...
	@RequestMapping(value = "/UpdateM_OR1_ReSub", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReportReSub(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute BRRS_M_OR1_ReportService.M_OR1_Resub_Summary_Entity request,
		...
		try {
			...
			M_OR1_service.updateResubReport(request);
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_CA4_Resub_Summary_Entity request, HttpServletRequest req) {
	 ...
	 * 
	 * @ResponseBody public List<ReportLineItemDTO>
	...
	public ResponseEntity<String> updateReport1(
		...
		try {
			...
			Object entityInstance = isResub ? new BRRS_M_LIQ_ReportService.M_LIQ_Archival_Manual_Summary_Entity()
...
//	}
	 ...
	 */
	@Autowired
	private BRRS_BDISB1_ReportService BDISB1reportService;

	@RequestMapping(value = "/BDISB1updateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAllReports(
	...
	@RequestMapping(value = "/UpdateM_INTRATESReSub", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReportReSub(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute M_INT_RATES_RESUB_Summary_Entity request,
		...
		try {
			...
			INTRATESreportService.updateResubReport(request);
	...
	@RequestMapping(value = "/UpdateM_INT_RATES_FCA_ReSub", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReportReSub(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute M_INT_RATES_FCA_RESUB_Summary_Entity request,
		...
		try {
			...
			INTRATESFCAreportService.updateResubReport(request);
	 ...
	 * 
	 * @ResponseBody public ResponseEntity<String> updateMOPTRAllReports(
	 * 
	 * @RequestParam @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
	 * 
	 * @RequestParam Map<String, String> allParams) { try {
	...
	@RequestMapping(value = "/M_OPTRupdateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAllReports(
	 ...
	 * asondate,
	 * 
	 * @ModelAttribute MDISB5_Summary_Entity1 entity1, @ModelAttribute
	 * MDISB5_Summary_Entity2 entity2,
	 * 
	 ...
	 * if (asondate != null) {
	 * 
	 * entity1.setReportDate(asondate); entity2.setReportDate(asondate);
	 * entity3.setReportDate(asondate);
	 * 
	 * System.out.println("Set Report Date: " + asondate);
	 * 
	 * } else { System.out.println("Using entity dates: " +
	 * entity1.getReportDate()); }
	 * 
	 * // Call service → creates versioned archival copies
	 * BRRS_MDISB5_ReportService.updateReportReSub(entity1, entity2, entity3);
	 * 
	 * return ResponseEntity.ok("Resubmission Updated Successfully");
	 * 
	 * } catch (Exception e) { e.printStackTrace(); return
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			OR2reportService.updateResubReport(request);
...
//	}
	...
	public ResponseEntity<String> updateAllReports(
		...
		try {
			System.out.println("Came to single controller"); // set date into all 4 entities
			request1.setReportDate(asondate);
...
//	}
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			M_SRWA_12FreportService.updateResubReport(request);
	...
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BRRS_M_EPR_ReportService.M_EPR_Summary_Entity request) {
	...
	@RequestMapping(value = "/UpdateM_EPR_ReSub", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReportReSub(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute BRRS_M_EPR_ReportService.M_EPR_RESUB_Summary_Entity request,
		...
		try {
			...
			brrs_m_epr_reportservice.updateResubReport(request);
	...
	@RequestMapping(value = "/M_LA2updateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAllReports(

			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,

			@ModelAttribute BRRS_M_LA2_ReportService.M_LA2_Summary_Entity request) {
	...
	public ResponseEntity<String> updateReportReSub(
			...
			@ModelAttribute BRRS_M_LA2_ReportService.M_LA2_RESUB_Summary_Entity request,

			HttpServletRequest req) {

		try {

			System.out.println("Came to M_LA2 Resub Controller");
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body("M_LA2 Resubmission Update Failed : " + e.getMessage());
		}
	}
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			// Call service to create a new versioned row
			BRRS_M_OB_reportservice.updateResubReport(request);
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_CA3_Resub_Summary_Entity request, HttpServletRequest req) {
	...
	@RequestMapping(value = "/UpdateM_CR_ReSub", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
		...
		try {
			...
			// Call service to create a new versioned row
			BRRS_M_CR_reportservice.updateResubReport(request);
...
//	}
	...
	@ResponseBody
	public ResponseEntity<String> updateMDISB1(@RequestParam @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
	...
	@ResponseBody
	public ResponseEntity<String> updateMDISB2(@RequestParam @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@RequestParam Map<String, String> allParams) {
	...
	@ResponseBody
	public ResponseEntity<String> updateMDISB3(@RequestParam @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@RequestParam Map<String, String> allParams) {
	...
	public ResponseEntity<String> updateSCH17NewReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute SCH_17_Manual_Summary_Entity1 request) {
		...
		try {
			...
			// call services
			BRRS_SCH_17_New_Service.updateSCH17NewReport(request);
	 ...
	 * // ? set the asondate into entity request.setReport_date(asondate);
	 * 
	 * // call services brrs_sch_17_reportservice.updateReport(request);
	 * 
	 * return ResponseEntity.ok("Modified Successfully."); } catch (Exception e) {
	 * e.printStackTrace(); return
	 * ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	...
	@ResponseBody
	public ResponseEntity<String> updateSCH17(@RequestParam @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@RequestParam Map<String, String> allParams) {
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			BRRS_M_BOP_ReportService.updateResubReport(request);
	...
	// Resubmission
	@Autowired
	BRRS_M_SRWA_12E_ReportService M_SRWA_12Eservice;
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			M_SRWA_12Eservice.updateResubReport(request);
	...
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_SRWA_12H_Summary_Entity request, HttpServletRequest req) {
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			M_SRWA_12Hservice.updateResubReport(request);
	...
	@Autowired
	private BRRS_M_TBS_ReportService BRRS_M_TBS_reportservice;

	@RequestMapping(value = "/M_TBSupdate", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_TBS_Resub_Summary_Entity request, HttpServletRequest req) {
		...
		try {
			...
			// Call service to create a new versioned row
			BRRS_M_TBS_reportservice.updateResubReport(request);
	...
	public ResponseEntity<String> updateReportReSub(
		...
		try {
			...
			BRRS_M_GP_ReportService.updateResubReport(request);
...
//	}
	...
	public ResponseEntity<String> updateReportReSub(
			...
			@ModelAttribute M_RPD_Summary_Entity6 request6, @ModelAttribute M_RPD_Summary_Entity7 request7,
			@ModelAttribute M_RPD_Summary_Entity8 request8, @ModelAttribute M_RPD_Summary_Entity9 request9,
			HttpServletRequest req) {
	...
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_GMIRT_Summary_Entity summary, @ModelAttribute M_GMIRT_Detail_Entity detail) {
	 ...
	 * asondate,
	 * 
	 * @ModelAttribute M_TBS_Summary_Entity request, HttpServletRequest req) {
	 * 
	 * try { System.out.println("Came to Resub Controller");
	 * 
	 * if (asondate != null) { // Set the asondate into the entity
	...
	public ResponseEntity<String> updateAllReports(
			...
			@ModelAttribute M_DEP3_Summary_Entity request1
	...
	public void detailDownloadpdf(HttpServletResponse response, @RequestParam("reportid") String reportid,
	...
	@RequestMapping(value = "/M_DEP4_updateAll", method = RequestMethod.POST)
	@ResponseBody
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_DEP4_Summary_Entity1 request1, @ModelAttribute M_DEP4_Summary_Entity2 request2,
			@ModelAttribute M_DEP4_Summary_Entity3 request3) {

		try {

			System.out.println("Came to M_DEP4 Update Controller");
			...
			if (asondate != null) {
				...
				System.out.println("Report Date Set : " + asondate);
			}
			...
			return ResponseEntity.ok("M_DEP4 Modified Successfully");
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body("M_DEP4 Update Failed : " + e.getMessage());
		}
	}
	 ...
	 * -------------------- RESUBMISSION --------------------
	 * 
	 * @RequestMapping(value = "/DEP4_ReSub", method = RequestMethod.POST)
	 * 
	 * @ResponseBody public ResponseEntity<String> updateReportReSub(
	 * 
	 * @RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date
	 ...
	 * 
	 * @ModelAttribute M_DEP4_Summary_Entity3 request3, HttpServletRequest req) {
	 * 
	 * try {
	 * 
	 * System.out.println("Came to M_DEP4 Resub Controller");
	 * 
	 * if (asondate != null) { request1.setReportDate(asondate);
	 * request2.setReportDate(asondate); request3.setReportDate(asondate);
	 * 
	 * System.out.println("Report Date Set : " + asondate); }
	 * 
	 * // Call Resub Service BRRS_M_DEP4_ReportService.updateReportReSub(request1,
	 * request2, request3);
	 * 
	 * return ResponseEntity.ok("M_DEP4 Resubmission Updated Successfully");
	 * 
	 * } catch (Exception e) {
	 * 
	 * e.printStackTrace();
	 ...
	 */
	@Autowired
	private BRRS_BDISB2_ReportService BDISB2reportService;

	@RequestMapping(value = "/BDISB2updateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAllReports(
	...
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BRRS_GL_SCH_ReportService.GL_SCH_Manual_Summary_Entity request) {
	...
	public void downloadMDISBConsolidatedExcel(@RequestParam(required = false) String asondate,
			...
			throws IOException, ParseException {
		System.out.println("SerdownloadConsolidatedExcelvice: Generating report ");
		byte[] file = regreportServices.getConsolidatedDownloadMDISBFile(filename, asondate, fromdate, todate, currency,
				type, format, version, dtltype);
		System.out.println("filename..." + filename);
	...
	public ResponseEntity<String> updateReportReSub(
			...
			@ModelAttribute M_SIR_Resub_Summary_Entity request,
		...
		try {
			...
			BRRS_M_SIR_ReportService.updateResubReport(request);
	...
	public ResponseEntity<String> updateReportReSub(
			...
			@ModelAttribute M_FXR_Resub_Summary_Entity request,
		...
		try {
			...
			M_FXR_service.updateResubReport(request);
	...
	@RequestMapping(value = "/AIDPupdateAll1", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateAIDPReports(
		...
		try {
			...
			// ===== SERVICE CALLS (RESUB) =====
			AIDPreportService.updateReport5(request1);
			AIDPreportService.updateReport6(request2);
			AIDPreportService.updateReport7(request3);
			AIDPreportService.updateReport8(request4);
...
//Modify Saving Method
	...
	@RequestMapping(value = "/FSIupdateAll", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public ResponseEntity<String> updateReport(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute FSI_Summary_Entity request) {
		try {
			System.out.println("came to single controller");
			...
			request.setREPORT_DATE(asondate);
			// call services
			BRRS_FSI_ReportService.updateReport(request);
