...
public class BRRS_ReportsController {
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_SRWA_12G_Resub_Summary_Entity request, HttpServletRequest req) {
...
//	}
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BDISB1_Summary_Entity request, HttpServletRequest req) {
	 ...
	 * 
	 * 
	 * // call services BDISB3reportService.updateReport(request1);
	 * 
	 * return ResponseEntity.ok("Modified Successfully."); } catch (Exception e) {
	 * e.printStackTrace(); return
	 * ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).
	...
	public ResponseEntity<String> updateReportReSubAll(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BDISB3_Summary_Entity request1, HttpServletRequest req) {
	 ...
	 * 
	 * @ResponseBody public ResponseEntity<String> updateMDISB5AllReports(
	 * 
	 * @RequestParam @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
	 * 
	 * @RequestParam Map<String, String> allParams) {
	 * 
	 * try { System.out.println("Came to MDISB5 Detail Update Controller");
	 * 
	...
	public ResponseEntity<String> updateAllReports(
	       ...
	       BRRS_MDISB5_ReportService.MDISB5_Summary_Entity1 request1,

	        BRRS_MDISB5_ReportService.MDISB5_Summary_Entity2 request2,

	         BRRS_MDISB5_ReportService.MDISB5_Summary_Entity3 request3) {
	    ...
	    try {
	        ...
	        System.out.println("R5_NAME_OF_SHAREHOLDER = "
	                + request1.getR5_NAME_OF_SHAREHOLDER());

	        System.out.println("R6_NAME_OF_SHAREHOLDER = "
	                + request1.getR6_NAME_OF_SHAREHOLDER());

	        System.out.println("R20_NAME_OF_BOARD_MEMBERS = "
	                + request2.getR20_NAME_OF_BOARD_MEMBERS());

	        System.out.println("R21_NAME_OF_BOARD_MEMBERS = "
	                + request2.getR21_NAME_OF_BOARD_MEMBERS());

	        System.out.println("R37_NAME = "
	                + request3.getR37_NAME());

	        System.out.println("R38_NAME = "
...
//	}
	...
	public ResponseEntity<String> updateReportReSub(
			...
			@ModelAttribute M_EPR_RESUB_Summary_Entity request,
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute M_LA2_Resub_Summary_Entity request, HttpServletRequest req) {
...
//	}
	...
	public ResponseEntity<String> updateReportReSub(
			@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
			@ModelAttribute BDISB2_Summary_Entity request, HttpServletRequest req) {
