...
@EnableJpaRepositories(basePackages = "com.bornfire.brrs.entities", entityManagerFactoryRef = "datasrc", transactionManagerRef = "datasrcTransactionManager")
public class BrrsDataSource {
    ...
    public LocalSessionFactoryBean datasrc() throws SQLException {
        ...
        sessionFactory.setPackagesToScan("com.bornfire.brrs.entities");
