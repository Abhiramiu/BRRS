...
@Entity
@Table(name = "BRRS_M_LARADV_ARCHIVALTABLE_DETAIL3")
@IdClass(M_LARADV_PK.class)
public class M_LARADV_Archival_Detail_Entity3 implements Serializable{
	...
	public M_LARADV_Archival_Detail_Entity3() {
		super();
