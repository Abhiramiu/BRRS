...
public class FORMAT_II_PK implements Serializable {
    ...
    public FORMAT_II_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FORMAT_II_PK)) return false;
        FORMAT_II_PK that = (FORMAT_II_PK) o;
