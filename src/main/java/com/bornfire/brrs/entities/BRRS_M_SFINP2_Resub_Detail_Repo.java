...
public interface BRRS_M_SFINP2_Resub_Detail_Repo extends JpaRepository<M_SFINP2_RESUB_Detail_Entity, String> {
	...
	@Query(value = "select * from BRRS_M_SFINP2_RESUB_DETAILTABLE where REPORT_LABEL =?1 and REPORT_ADDL_CRITERIA_1=?2 AND REPORT_DATE=?3 AND DATA_ENTRY_VERSION=?4", nativeQuery = true)
	List<M_SFINP2_RESUB_Detail_Entity> GetDataByRowIdAndColumnId(String reportLable,String reportAddlCriteria_1,Date reportdate,String DATA_ENTRY_VERSION);
}
