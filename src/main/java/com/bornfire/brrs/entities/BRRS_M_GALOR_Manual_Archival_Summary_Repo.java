...
@Repository
public interface BRRS_M_GALOR_Manual_Archival_Summary_Repo extends JpaRepository<M_GALOR_Manual_Archival_Summary_Entity, M_GALOR_PK> {
    ...
    @Query(value = "SELECT REPORT_DATE, REPORT_VERSION " +
                   "FROM BRRS_M_GALOR_MANUAL_ARCHIVALTABLE_SUMMARY " +
    ...
    // -------------------------------------------------------
    @Query(value = "SELECT * FROM BRRS_M_GALOR_MANUAL_ARCHIVALTABLE_SUMMARY " +
                   "WHERE REPORT_DATE = ?1 " +
                   "AND REPORT_VERSION = ?2",
           nativeQuery = true)
    List<M_GALOR_Manual_Archival_Summary_Entity> 
