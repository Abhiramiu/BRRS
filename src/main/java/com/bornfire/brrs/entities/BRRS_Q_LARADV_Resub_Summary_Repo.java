...
public interface BRRS_Q_LARADV_Resub_Summary_Repo  extends JpaRepository<Q_LARADV_Resub_Summary_Entity, Long> {

	 @Query(value = "SELECT * FROM BRRS_Q_LARADV_RESUB_SUMMARYTABLE a WHERE a.REPORT_DATE = ?1 AND REPORT_VERSION = ?2",
	            nativeQuery = true)
