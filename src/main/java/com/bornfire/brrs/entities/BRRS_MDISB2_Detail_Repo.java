...
public interface BRRS_MDISB2_Detail_Repo extends JpaRepository<MDISB2_Detail_Entity, Long> {
    ...
    List<MDISB2_Detail_Entity> findByReportDateAndReportLableAndReportAddlCriteria1(
            Date reportDate,
            String reportLabel,
	...
	MDISB2_Detail_Entity findBySno(@Param("Sno") String Sno);
