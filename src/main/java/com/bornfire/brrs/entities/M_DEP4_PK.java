...
public class M_DEP4_PK implements Serializable {
    ...
    public M_DEP4_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_DEP4_PK)) return false;
        M_DEP4_PK that = (M_DEP4_PK) o;
