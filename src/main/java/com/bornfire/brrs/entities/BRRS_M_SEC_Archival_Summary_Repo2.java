...
public interface BRRS_M_SEC_Archival_Summary_Repo2
    ...
    List<BRRS_M_SEC_Archival_Summary_Entity2> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);
    ...
    Optional<BRRS_M_SEC_Archival_Summary_Entity2> findByReportDateAndReportVersion(Date reportDate, BigDecimal reportVersion);
