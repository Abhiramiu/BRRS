...
@Entity
@Table(name="M_IRB_DETAIL_TABLE")
public class BRRS_M_IRB_DETAILS_ENTITY {
    ...
    public BRRS_M_IRB_DETAILS_ENTITY() {}

    public BRRS_M_IRB_DETAILS_ENTITY(String cust_id, String acct_number, String acct_name, String data_type, String row_id,
