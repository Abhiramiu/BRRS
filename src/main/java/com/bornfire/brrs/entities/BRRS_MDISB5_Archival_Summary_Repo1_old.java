...
public interface BRRS_MDISB5_Archival_Summary_Repo1_old extends JpaRepository<MDISB5_Archival_Summary_Entity1_old, MDISB5_Archival_Summary1_PK> {
    ...
    List<MDISB5_Archival_Summary_Entity1_old> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);
    ...
    Optional<MDISB5_Archival_Summary_Entity1_old> getLatestArchivalVersionByDate(Date reportDate);
    ...
    List<MDISB5_Archival_Summary_Entity1_old> getdatabydateListWithVersion();
    ...
    List<MDISB5_Archival_Summary_Entity1_old> getdatabydateListWithVersionAll();
}
