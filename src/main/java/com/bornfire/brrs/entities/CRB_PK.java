...
public class CRB_PK implements Serializable {
    ...
    public CRB_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CRB_PK)) return false;
        CRB_PK that = (CRB_PK) o;
