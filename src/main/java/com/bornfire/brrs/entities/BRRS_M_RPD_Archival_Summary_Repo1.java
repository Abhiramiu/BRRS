...
public interface BRRS_M_RPD_Archival_Summary_Repo1  extends JpaRepository<BRRS_M_RPD_Archival_Summary_Entity1, Date> {
    ...
    List<BRRS_M_RPD_Archival_Summary_Entity1> getdatabydateListarchival(Date report_date, String report_version);
}
