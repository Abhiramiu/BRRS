...
public interface BRRS_M_RPD_Archival_Summary_Repo1  extends JpaRepository<BRRS_M_RPD_Archival_Summary_Entity1, M_RPD_Archival_Summary1_PK> {
    ...
    List<BRRS_M_RPD_Archival_Summary_Entity1> getdatabydateListarchival(Date reportDate, String reportVersion);
