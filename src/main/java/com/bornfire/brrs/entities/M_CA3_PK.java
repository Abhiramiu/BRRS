...
public class M_CA3_PK implements Serializable {
    ...
    public M_CA3_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_CA3_PK)) return false;
        M_CA3_PK that = (M_CA3_PK) o;
