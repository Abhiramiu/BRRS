...
@Repository
public interface BRRS_M_LARADV_Archival_Summary_Repo1
        extends JpaRepository<M_LARADV_Archival_Summary_Entity1,M_LARADV_Archival_Summary1_PK> {
    ...
    List<M_LARADV_Archival_Summary_Entity1> getdatabydateListarchival(Date reportDate, String reportVersion);
    ...
    Optional<M_LARADV_Summary_Entity1> findByReportDateAndReportVersion(Date reportDate, String reportVersion);
