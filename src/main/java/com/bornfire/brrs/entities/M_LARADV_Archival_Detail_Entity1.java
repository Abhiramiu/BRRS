...
@Entity
@Table(name = "BRRS_M_LARADV_ARCHIVALTABLE_DETAIL1")
@IdClass(M_LARADV_PK.class)
public class M_LARADV_Archival_Detail_Entity1 implements Serializable{
	...
	public void setReportVersion(String reportVersion) {
		this.report_version = reportVersion;
	}
	...
	public M_LARADV_Archival_Detail_Entity1() {
		super();
