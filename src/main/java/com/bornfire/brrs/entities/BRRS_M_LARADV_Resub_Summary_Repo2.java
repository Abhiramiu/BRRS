...
public interface BRRS_M_LARADV_Resub_Summary_Repo2 extends JpaRepository<M_LARADV_Resub_Summary_Entity2, M_LARADV_PK> {
	...
	@Query("SELECT e FROM M_LARADV_Resub_Summary_Entity2 e " + "WHERE e.report_date = :reportDate "
	...
	@Query(value = "SELECT NVL(MAX(report_version), 0) FROM BRRS_M_LARADV_RESUBTABLE_SUMMARY2", nativeQuery = true)
