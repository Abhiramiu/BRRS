...
public class M_CR_PK implements Serializable {
    ...
    public M_CR_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_CR_PK)) return false;
        M_CR_PK that = (M_CR_PK) o;
