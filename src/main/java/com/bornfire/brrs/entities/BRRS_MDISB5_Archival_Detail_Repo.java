...
public interface BRRS_MDISB5_Archival_Detail_Repo extends JpaRepository<MDISB5_Archival_Detail_Entity,String> {
	...
	@Query(value = "select * from BRRS_MDISB5_ARCHIVALTABLE_DETAIL where REPORT_LABLE =?1 and REPORT_ADDL_CRITERIA_1=?2 AND REPORT_DATE=?3 AND DATA_ENTRY_VERSION=?4", nativeQuery = true)
	List<MDISB5_Archival_Detail_Entity> GetDataByRowIdAndColumnId(String reportLable,String reportAddlCriteria_1,Date reportdate,String DATA_ENTRY_VERSION);
