...
@Entity
@Table(name = "BRRS_CASH_FLOW_ARCHIVALTABLE_SUMMARY")
@IdClass(CASH_FLOW_PK.class)
public class CASH_FLOW_Archival_Summary_Entity {

    // ----------- R9 to R51 -----------

    @Column(name = "R9_PRODUCT") private String r9_product;
    @Column(name = "R9_LC_AS_ON_MAR") private BigDecimal r9_lc_as_on_mar;
    @Column(name = "R9_LC_AS_ON_SEP") private BigDecimal r9_lc_as_on_sep;

    @Column(name = "R10_PRODUCT") private String r10_product;
    @Column(name = "R10_LC_AS_ON_MAR") private BigDecimal r10_lc_as_on_mar;
    @Column(name = "R10_LC_AS_ON_SEP") private BigDecimal r10_lc_as_on_sep;

    @Column(name = "R11_PRODUCT") private String r11_product;
    @Column(name = "R11_LC_AS_ON_MAR") private BigDecimal r11_lc_as_on_mar;
    @Column(name = "R11_LC_AS_ON_SEP") private BigDecimal r11_lc_as_on_sep;

    @Column(name = "R12_PRODUCT") private String r12_product;
    @Column(name = "R12_LC_AS_ON_MAR") private BigDecimal r12_lc_as_on_mar;
    @Column(name = "R12_LC_AS_ON_SEP") private BigDecimal r12_lc_as_on_sep;

    @Column(name = "R13_PRODUCT") private String r13_product;
    @Column(name = "R13_LC_AS_ON_MAR") private BigDecimal r13_lc_as_on_mar;
    @Column(name = "R13_LC_AS_ON_SEP") private BigDecimal r13_lc_as_on_sep;

    @Column(name = "R14_PRODUCT") private String r14_product;
    @Column(name = "R14_LC_AS_ON_MAR") private BigDecimal r14_lc_as_on_mar;
    @Column(name = "R14_LC_AS_ON_SEP") private BigDecimal r14_lc_as_on_sep;

    @Column(name = "R15_PRODUCT") private String r15_product;
    @Column(name = "R15_LC_AS_ON_MAR") private BigDecimal r15_lc_as_on_mar;
    @Column(name = "R15_LC_AS_ON_SEP") private BigDecimal r15_lc_as_on_sep;

    @Column(name = "R16_PRODUCT") private String r16_product;
    @Column(name = "R16_LC_AS_ON_MAR") private BigDecimal r16_lc_as_on_mar;
    @Column(name = "R16_LC_AS_ON_SEP") private BigDecimal r16_lc_as_on_sep;

    @Column(name = "R17_PRODUCT") private String r17_product;
    @Column(name = "R17_LC_AS_ON_MAR") private BigDecimal r17_lc_as_on_mar;
    @Column(name = "R17_LC_AS_ON_SEP") private BigDecimal r17_lc_as_on_sep;

    @Column(name = "R18_PRODUCT") private String r18_product;
    @Column(name = "R18_LC_AS_ON_MAR") private BigDecimal r18_lc_as_on_mar;
    @Column(name = "R18_LC_AS_ON_SEP") private BigDecimal r18_lc_as_on_sep;

    @Column(name = "R19_PRODUCT") private String r19_product;
    @Column(name = "R19_LC_AS_ON_MAR") private BigDecimal r19_lc_as_on_mar;
    @Column(name = "R19_LC_AS_ON_SEP") private BigDecimal r19_lc_as_on_sep;

    @Column(name = "R20_PRODUCT") private String r20_product;
    @Column(name = "R20_LC_AS_ON_MAR") private BigDecimal r20_lc_as_on_mar;
    @Column(name = "R20_LC_AS_ON_SEP") private BigDecimal r20_lc_as_on_sep;

    @Column(name = "R21_PRODUCT") private String r21_product;
    @Column(name = "R21_LC_AS_ON_MAR") private BigDecimal r21_lc_as_on_mar;
    @Column(name = "R21_LC_AS_ON_SEP") private BigDecimal r21_lc_as_on_sep;

    @Column(name = "R22_PRODUCT") private String r22_product;
    @Column(name = "R22_LC_AS_ON_MAR") private BigDecimal r22_lc_as_on_mar;
    @Column(name = "R22_LC_AS_ON_SEP") private BigDecimal r22_lc_as_on_sep;

    @Column(name = "R23_PRODUCT") private String r23_product;
    @Column(name = "R23_LC_AS_ON_MAR") private BigDecimal r23_lc_as_on_mar;
    @Column(name = "R23_LC_AS_ON_SEP") private BigDecimal r23_lc_as_on_sep;

    @Column(name = "R24_PRODUCT") private String r24_product;
    @Column(name = "R24_LC_AS_ON_MAR") private BigDecimal r24_lc_as_on_mar;
    @Column(name = "R24_LC_AS_ON_SEP") private BigDecimal r24_lc_as_on_sep;

    @Column(name = "R25_PRODUCT") private String r25_product;
    @Column(name = "R25_LC_AS_ON_MAR") private BigDecimal r25_lc_as_on_mar;
    @Column(name = "R25_LC_AS_ON_SEP") private BigDecimal r25_lc_as_on_sep;

    @Column(name = "R26_PRODUCT") private String r26_product;
    @Column(name = "R26_LC_AS_ON_MAR") private BigDecimal r26_lc_as_on_mar;
    @Column(name = "R26_LC_AS_ON_SEP") private BigDecimal r26_lc_as_on_sep;

    @Column(name = "R27_PRODUCT") private String r27_product;
    @Column(name = "R27_LC_AS_ON_MAR") private BigDecimal r27_lc_as_on_mar;
    @Column(name = "R27_LC_AS_ON_SEP") private BigDecimal r27_lc_as_on_sep;

    @Column(name = "R28_PRODUCT") private String r28_product;
    @Column(name = "R28_LC_AS_ON_MAR") private BigDecimal r28_lc_as_on_mar;
    @Column(name = "R28_LC_AS_ON_SEP") private BigDecimal r28_lc_as_on_sep;

    @Column(name = "R29_PRODUCT") private String r29_product;
    @Column(name = "R29_LC_AS_ON_MAR") private BigDecimal r29_lc_as_on_mar;
    @Column(name = "R29_LC_AS_ON_SEP") private BigDecimal r29_lc_as_on_sep;

    @Column(name = "R30_PRODUCT") private String r30_product;
    @Column(name = "R30_LC_AS_ON_MAR") private BigDecimal r30_lc_as_on_mar;
    @Column(name = "R30_LC_AS_ON_SEP") private BigDecimal r30_lc_as_on_sep;

    @Column(name = "R31_PRODUCT") private String r31_product;
    @Column(name = "R31_LC_AS_ON_MAR") private BigDecimal r31_lc_as_on_mar;
    @Column(name = "R31_LC_AS_ON_SEP") private BigDecimal r31_lc_as_on_sep;

    @Column(name = "R32_PRODUCT") private String r32_product;
    @Column(name = "R32_LC_AS_ON_MAR") private BigDecimal r32_lc_as_on_mar;
    @Column(name = "R32_LC_AS_ON_SEP") private BigDecimal r32_lc_as_on_sep;

    @Column(name = "R33_PRODUCT") private String r33_product;
    @Column(name = "R33_LC_AS_ON_MAR") private BigDecimal r33_lc_as_on_mar;
    @Column(name = "R33_LC_AS_ON_SEP") private BigDecimal r33_lc_as_on_sep;

    @Column(name = "R34_PRODUCT") private String r34_product;
    @Column(name = "R34_LC_AS_ON_MAR") private BigDecimal r34_lc_as_on_mar;
    @Column(name = "R34_LC_AS_ON_SEP") private BigDecimal r34_lc_as_on_sep;

    @Column(name = "R35_PRODUCT") private String r35_product;
    @Column(name = "R35_LC_AS_ON_MAR") private BigDecimal r35_lc_as_on_mar;
    @Column(name = "R35_LC_AS_ON_SEP") private BigDecimal r35_lc_as_on_sep;

    @Column(name = "R36_PRODUCT") private String r36_product;
    @Column(name = "R36_LC_AS_ON_MAR") private BigDecimal r36_lc_as_on_mar;
    @Column(name = "R36_LC_AS_ON_SEP") private BigDecimal r36_lc_as_on_sep;

    @Column(name = "R37_PRODUCT") private String r37_product;
    @Column(name = "R37_LC_AS_ON_MAR") private BigDecimal r37_lc_as_on_mar;
    @Column(name = "R37_LC_AS_ON_SEP") private BigDecimal r37_lc_as_on_sep;

    @Column(name = "R38_PRODUCT") private String r38_product;
    @Column(name = "R38_LC_AS_ON_MAR") private BigDecimal r38_lc_as_on_mar;
    @Column(name = "R38_LC_AS_ON_SEP") private BigDecimal r38_lc_as_on_sep;

    @Column(name = "R39_PRODUCT") private String r39_product;
    @Column(name = "R39_LC_AS_ON_MAR") private BigDecimal r39_lc_as_on_mar;
    @Column(name = "R39_LC_AS_ON_SEP") private BigDecimal r39_lc_as_on_sep;

    @Column(name = "R40_PRODUCT") private String r40_product;
    @Column(name = "R40_LC_AS_ON_MAR") private BigDecimal r40_lc_as_on_mar;
    @Column(name = "R40_LC_AS_ON_SEP") private BigDecimal r40_lc_as_on_sep;

    @Column(name = "R41_PRODUCT") private String r41_product;
    @Column(name = "R41_LC_AS_ON_MAR") private BigDecimal r41_lc_as_on_mar;
    @Column(name = "R41_LC_AS_ON_SEP") private BigDecimal r41_lc_as_on_sep;

    @Column(name = "R42_PRODUCT") private String r42_product;
    @Column(name = "R42_LC_AS_ON_MAR") private BigDecimal r42_lc_as_on_mar;
    @Column(name = "R42_LC_AS_ON_SEP") private BigDecimal r42_lc_as_on_sep;

    @Column(name = "R43_PRODUCT") private String r43_product;
    @Column(name = "R43_LC_AS_ON_MAR") private BigDecimal r43_lc_as_on_mar;
    @Column(name = "R43_LC_AS_ON_SEP") private BigDecimal r43_lc_as_on_sep;

    @Column(name = "R44_PRODUCT") private String r44_product;
    @Column(name = "R44_LC_AS_ON_MAR") private BigDecimal r44_lc_as_on_mar;
    @Column(name = "R44_LC_AS_ON_SEP") private BigDecimal r44_lc_as_on_sep;

    @Column(name = "R45_PRODUCT") private String r45_product;
    @Column(name = "R45_LC_AS_ON_MAR") private BigDecimal r45_lc_as_on_mar;
    @Column(name = "R45_LC_AS_ON_SEP") private BigDecimal r45_lc_as_on_sep;

    @Column(name = "R46_PRODUCT") private String r46_product;
    @Column(name = "R46_LC_AS_ON_MAR") private BigDecimal r46_lc_as_on_mar;
    @Column(name = "R46_LC_AS_ON_SEP") private BigDecimal r46_lc_as_on_sep;

    @Column(name = "R47_PRODUCT") private String r47_product;
    @Column(name = "R47_LC_AS_ON_MAR") private BigDecimal r47_lc_as_on_mar;
    @Column(name = "R47_LC_AS_ON_SEP") private BigDecimal r47_lc_as_on_sep;

    @Column(name = "R48_PRODUCT") private String r48_product;
    @Column(name = "R48_LC_AS_ON_MAR") private BigDecimal r48_lc_as_on_mar;
    @Column(name = "R48_LC_AS_ON_SEP") private BigDecimal r48_lc_as_on_sep;

    @Column(name = "R49_PRODUCT") private String r49_product;
    @Column(name = "R49_LC_AS_ON_MAR") private BigDecimal r49_lc_as_on_mar;
    @Column(name = "R49_LC_AS_ON_SEP") private BigDecimal r49_lc_as_on_sep;

    @Column(name = "R50_PRODUCT") private String r50_product;
    @Column(name = "R50_LC_AS_ON_MAR") private BigDecimal r50_lc_as_on_mar;
    @Column(name = "R50_LC_AS_ON_SEP") private BigDecimal r50_lc_as_on_sep;

    @Column(name = "R51_PRODUCT") private String r51_product;
    @Column(name = "R51_LC_AS_ON_MAR") private BigDecimal r51_lc_as_on_mar;
    @Column(name = "R51_LC_AS_ON_SEP") private BigDecimal r51_lc_as_on_sep;
	...
	public CASH_FLOW_Archival_Summary_Entity() {
		super();
	}
