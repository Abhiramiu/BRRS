...
public interface BRRS_M_SEC_Archival_Summary_Repo3 extends JpaRepository<BRRS_M_SEC_Archival_Summary_Entity3, Date> {
	   ...
	   @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_M_SEC_ARCHIVALTABLE_SUMMARY3 order by REPORT_VERSION", nativeQuery = true)
	    ...
	    List<BRRS_M_SEC_Archival_Summary_Entity3> getdatabydateListarchival(Date report_date, String report_version);
}