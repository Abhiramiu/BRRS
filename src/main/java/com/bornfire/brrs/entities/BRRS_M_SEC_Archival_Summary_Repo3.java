...
public interface BRRS_M_SEC_Archival_Summary_Repo3
    ...
    List<BRRS_M_SEC_Archival_Summary_Entity3> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);
    ...
    Optional<BRRS_M_SEC_Archival_Summary_Entity3> findByReportDateAndReportVersion(Date reportDate, BigDecimal reportVersion);
