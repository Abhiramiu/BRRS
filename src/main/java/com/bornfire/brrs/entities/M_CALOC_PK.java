...
public class M_CALOC_PK implements Serializable {
    ...
    public M_CALOC_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_CALOC_PK)) return false;
        M_CALOC_PK that = (M_CALOC_PK) o;
