...
@Repository
public interface BRRS_Q_BRANCHNET_Archival_Summary_Repo
    extends JpaRepository<Q_BRANCHNET_Archival_Summary_Entity, Q_BRANCHNET_PK> {
    ...
    @Query("SELECT MAX(e.reportVersion) FROM Q_BRANCHNET_Archival_Summary_Entity e WHERE e.reportDate = :date")
