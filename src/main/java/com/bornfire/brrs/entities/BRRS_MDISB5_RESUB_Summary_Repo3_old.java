...
@Repository
public interface BRRS_MDISB5_RESUB_Summary_Repo3_old extends JpaRepository<MDISB5_RESUB_Summary_Entity3_old, MDISB5_PK> {

	@Query(value = "select * from BRRS_MDISB5_RESUB_SUMMARYTABLE3 where REPORT_DATE = ?1 and REPORT_VERSION = ?2", nativeQuery = true)
	List<MDISB5_RESUB_Summary_Entity3_old> getdatabydateListarchival(Date report_date, BigDecimal report_version);
	...
	List<MDISB5_RESUB_Summary_Entity3_old> getdatabydateListWithVersion();
