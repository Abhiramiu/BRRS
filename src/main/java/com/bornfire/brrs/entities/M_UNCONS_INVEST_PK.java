...
public class M_UNCONS_INVEST_PK implements Serializable {

    private Date reportDate;
    private BigDecimal reportVersion;

    // default constructor
    public M_UNCONS_INVEST_PK() {}

    // parameterized constructor
    public M_UNCONS_INVEST_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_UNCONS_INVEST_PK)) return false;
        M_UNCONS_INVEST_PK that = (M_UNCONS_INVEST_PK) o;
