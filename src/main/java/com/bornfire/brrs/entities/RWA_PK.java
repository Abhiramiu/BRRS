...
public class RWA_PK implements Serializable {
    ...
    public RWA_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RWA_PK)) return false;
        RWA_PK that = (RWA_PK) o;
