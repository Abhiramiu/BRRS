...
@Entity
@Table(name = "BRRS_Q_SMME_LOANS_ADVANCES_NEW_DETAILTABLE")
public class Q_SMME_Loans_Advances_New_Detail_Entity {
    ...
    public Q_SMME_Loans_Advances_New_Detail_Entity() {
        super();
    }
