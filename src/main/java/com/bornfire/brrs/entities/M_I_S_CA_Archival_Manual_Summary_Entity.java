...
@Entity
@Table(name = "BRRS_M_I_S_CA_MANUAL_ARCHIVALTABLE_SUMMARY")


public class M_I_S_CA_Archival_Manual_Summary_Entity {
	...
	public M_I_S_CA_Archival_Manual_Summary_Entity() {
		super();
