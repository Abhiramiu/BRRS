...
public class M_SRWA_12H_PK implements Serializable {

    private Date reportDate;
    private BigDecimal reportVersion;

    // default constructor
    public M_SRWA_12H_PK() {}

    // parameterized constructor
    public M_SRWA_12H_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_SRWA_12H_PK)) return false;
        M_SRWA_12H_PK that = (M_SRWA_12H_PK) o;
