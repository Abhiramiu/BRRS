...
public class Q_ATF_PK implements Serializable {
    ...
    public Q_ATF_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Q_ATF_PK)) return false;
        Q_ATF_PK that = (Q_ATF_PK) o;
