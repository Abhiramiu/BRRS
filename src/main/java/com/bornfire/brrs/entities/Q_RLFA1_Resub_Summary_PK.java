...
public class Q_RLFA1_Resub_Summary_PK implements Serializable {

    private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public Q_RLFA1_Resub_Summary_PK() {}

    // parameterized constructor
    public Q_RLFA1_Resub_Summary_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Q_RLFA1_Resub_Summary_PK)) return false;
        Q_RLFA1_Resub_Summary_PK that = (Q_RLFA1_Resub_Summary_PK) o;
