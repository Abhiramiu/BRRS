...
public class M_TBS_PK implements Serializable {
    ...
    public M_TBS_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_TBS_PK)) return false;
        M_TBS_PK that = (M_TBS_PK) o;
