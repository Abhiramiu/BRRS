...
public interface BRRS_M_AIDP_Archival_Summary_Repo4 extends JpaRepository<M_AIDP_Archival_Summary_Entity4, M_AIDP_PK> {
	...
	@Query(value = "select * from BRRS_M_AIDP_ARCHIVALTABLE_SUMMARY4 ", nativeQuery = true)
	static List<M_AIDP_Archival_Summary_Entity4> getdatabydateList(Date rpt_code) {
