...
@Repository
public interface BRRS_M_AIDP_Archival_Summary_Repo4 extends JpaRepository<M_AIDP_Archival_Summary_Entity4, Date> {
    ...
    List<M_AIDP_Archival_Summary_Entity4> getdatabydateListarchival(Date report_date, String report_version);
}
