...
@Entity
@Table(name = "BRRS_M_UNCONS_INVEST_ARCHIVALTABLE_SUMMARY4")

public class M_UNCONS_INVEST_Archival_Summary_Entity4 {
	...
	public M_UNCONS_INVEST_Archival_Summary_Entity4() {
		super();
