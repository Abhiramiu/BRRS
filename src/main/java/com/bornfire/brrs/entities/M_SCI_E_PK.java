...
public class M_SCI_E_PK implements Serializable {
    ...
    public M_SCI_E_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_SCI_E_PK)) return false;
        M_SCI_E_PK that = (M_SCI_E_PK) o;
