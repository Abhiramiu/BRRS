...
@Entity
@Table(name = "BRRS_Q_LARADV_DETAILTABLE")
public class Q_LARADV_Detail_Entity {
	
	@Id
	    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "brrs_q_laradv_detail_seq_gen")
	    @SequenceGenerator(
	            name = "brrs_q_laradv_detail_seq_gen",
	            sequenceName = "BRRS_Q_LARADV_DETAILTABLE_SNO_SEQ",
	            allocationSize = 1
	    )
	    @Column(name = "SNO")
	    private Long sno;
