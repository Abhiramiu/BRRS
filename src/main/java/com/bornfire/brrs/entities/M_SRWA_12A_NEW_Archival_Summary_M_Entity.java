...
@Entity
@Table(name = "BRRS_M_SRWA_12A_NEW_ARCHIVALTABLE_SUMMARY_M")


public class M_SRWA_12A_NEW_Archival_Summary_M_Entity {
	...
	public M_SRWA_12A_NEW_Archival_Summary_M_Entity() {
		super();
