...
public interface BRRS_M_SRWA_12F_Archival_Summary_Repo
    extends JpaRepository<M_SRWA_12F_Archival_Summary_Entity, M_SRWA_12F_PK> {
    ...
    @Query("SELECT MAX(e.reportVersion) FROM M_SRWA_12F_Archival_Summary_Entity e WHERE e.reportDate = :date")
