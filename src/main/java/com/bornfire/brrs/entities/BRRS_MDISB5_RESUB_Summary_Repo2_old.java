...
@Repository
public interface BRRS_MDISB5_RESUB_Summary_Repo2_old extends JpaRepository<MDISB5_RESUB_Summary_Entity2_old, MDISB5_PK> {
	...
	@Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_MDISB5_RESUB_SUMMARYTABLE2 order by REPORT_VERSION", nativeQuery = true)
