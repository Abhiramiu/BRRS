...
public class M_P_L_PK implements Serializable {
    ...
    public M_P_L_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_P_L_PK)) return false;
        M_P_L_PK that = (M_P_L_PK) o;
