...
public class M_CA3_Archival_Summary_PK implements Serializable {

    private Date report_date;
    private String report_version;

    // default constructor
    public M_CA3_Archival_Summary_PK() {}

    // parameterized constructor
    public M_CA3_Archival_Summary_PK(Date report_date, String report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_CA3_Archival_Summary_PK)) return false;
        M_CA3_Archival_Summary_PK that = (M_CA3_Archival_Summary_PK) o;
