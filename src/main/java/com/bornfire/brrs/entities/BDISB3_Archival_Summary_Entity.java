...
@Entity
@Table(name = "BRRS_BDISB3_ARCHIVALTABLE_SUMMARY")
@IdClass(BDISB3_Archival_Summary_PK.class)

public class BDISB3_Archival_Summary_Entity{	
	...
	public BDISB3_Archival_Summary_Entity() {
		super();
