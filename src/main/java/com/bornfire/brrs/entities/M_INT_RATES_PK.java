...
public class M_INT_RATES_PK implements Serializable {

    private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public M_INT_RATES_PK() {}

    // parameterized constructor
    public M_INT_RATES_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_INT_RATES_PK)) return false;
        M_INT_RATES_PK that = (M_INT_RATES_PK) o;
