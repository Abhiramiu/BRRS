...
public class TIER_1_2_CFS_PK implements Serializable {

    private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public TIER_1_2_CFS_PK() {}

    // parameterized constructor
    public TIER_1_2_CFS_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TIER_1_2_CFS_PK)) return false;
        TIER_1_2_CFS_PK that = (TIER_1_2_CFS_PK) o;
