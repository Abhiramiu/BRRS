...
public class M_OB_Archival_Summary_PK implements Serializable {

    private Date reportDate;
    private String reportVersion;

    // default constructor
    public M_OB_Archival_Summary_PK() {}

    // parameterized constructor
    public M_OB_Archival_Summary_PK(Date reportDate, String reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_OB_Archival_Summary_PK)) return false;
        M_OB_Archival_Summary_PK that = (M_OB_Archival_Summary_PK) o;
