...
public class M_GALOR_PK implements Serializable {
    ...
    public M_GALOR_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_GALOR_PK)) return false;
        M_GALOR_PK that = (M_GALOR_PK) o;
