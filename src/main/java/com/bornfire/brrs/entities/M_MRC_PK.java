...
public class M_MRC_PK implements Serializable {
    ...
    public M_MRC_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_MRC_PK)) return false;
        M_MRC_PK that = (M_MRC_PK) o;
