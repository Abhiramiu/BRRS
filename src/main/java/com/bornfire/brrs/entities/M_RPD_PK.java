...
public class M_RPD_PK implements Serializable {
    ...
    public M_RPD_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_RPD_PK)) return false;
        M_RPD_PK that = (M_RPD_PK) o;
