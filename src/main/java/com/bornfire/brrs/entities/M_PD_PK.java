...
public class M_PD_PK implements Serializable {
    ...
    public M_PD_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_PD_PK)) return false;
        M_PD_PK that = (M_PD_PK) o;
