...
public interface BRRS_M_SEC_Archival_Summary_Repo4
    ...
    List<BRRS_M_SEC_Archival_Summary_Entity4> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);

    // Fetch latest archival version for given date (no version input)
    @Query(value = "SELECT * FROM BRRS_M_SEC_ARCHIVALTABLE_SUMMARY4 "
    ...
    Optional<BRRS_M_SEC_Archival_Summary_Entity4> findByReportDateAndReportVersion(Date reportDate, BigDecimal reportVersion);
