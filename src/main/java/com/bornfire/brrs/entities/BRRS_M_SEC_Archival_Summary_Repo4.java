...
public interface BRRS_M_SEC_Archival_Summary_Repo4
    ...
    @Query(value = "SELECT * FROM BRRS_M_SEC_ARCHIVALTABLE_SUMMARY4 " +
           ...
           nativeQuery = true)
    List<BRRS_M_SEC_Archival_Summary_Entity4> getdatabydateListarchival(
    ...
    @Query(value = "SELECT * FROM BRRS_M_SEC_ARCHIVALTABLE_SUMMARY4 " +
           ...
           nativeQuery = true)
    Optional<BRRS_M_SEC_Archival_Summary_Entity4> getLatestArchivalVersionByDate(
            Date reportDate);

    // Fetch by primary key (FIXED incorrect return type)
    Optional<BRRS_M_SEC_Archival_Summary_Entity4> findByReportDateAndReportVersion(
            Date reportDate, String reportVersion);
