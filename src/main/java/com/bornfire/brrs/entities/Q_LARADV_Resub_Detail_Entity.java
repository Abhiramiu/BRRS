...
@Entity
@Table(name = "BRRS_Q_LARADV_RESUB_DETAILTABLE")
public class Q_LARADV_Resub_Detail_Entity {
	
	@Id
	@GeneratedValue(
	        strategy = GenerationType.SEQUENCE,
	        generator = "brrs_q_laradv_resub_detailtable_seq_gen"
	)
	@SequenceGenerator(
	        name = "brrs_q_laradv_resub_detailtable_seq_gen",
	        sequenceName = "BRRS_Q_LARADV_RESUB_DETAILTABLE_SNO_SEQ",
	        allocationSize = 1
	)
	@Column(name = "SNO")
	private Long sno;
