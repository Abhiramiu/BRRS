...
@Repository
public interface BRRS_M_TOP_100_BORROWER_Archival_Summary_Repo extends JpaRepository<M_TOP_100_BORROWER_Archival_Summary_Entity, Date> {

    @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_M_TOP_100_BORROWER_ARCHIVALTABLE_SUMMARY order by REPORT_VERSION", nativeQuery = true)
