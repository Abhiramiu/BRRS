...
public interface BRRS_Q_STAFF_Summary_Repo3
    ...
    Optional<Q_STAFF_Summary_Entity3> findTopByReportDateOrderByReportVersionDesc(Date reportDate);

//     @Query("SELECT q FROM Q_STAFF_Summary_Entity3 q WHERE q.reportDate = :reportDate AND q.reportVersion = :reportVersion")
//     Optional<Q_STAFF_Summary_Entity3> findByReportDateAndReportVersion(@Param("reportDate") Date reportDate,
