...
@Repository
public interface BRRS_PL_SCHS_Archival_Summary_Repo extends JpaRepository<PL_SCHS_Archival_Summary_Entity, PL_SCHS_PK> {
    ...
    @Query(value = "SELECT * FROM BRRS_PL_SCHS_ARCHIVALTABLE_SUMMARY WHERE REPORT_VERSION IS NOT NULL ORDER BY REPORT_VERSION ASC", nativeQuery = true)
    List<PL_SCHS_Archival_Summary_Entity> getdatabydateListWithVersion();
}
