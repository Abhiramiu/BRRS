...
public class Q_SMME_DEP_PK implements Serializable {

    private Date reportDate;
    private BigDecimal reportVersion;

    // default constructor
    public Q_SMME_DEP_PK() {}

    // parameterized constructor
    public Q_SMME_DEP_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Q_SMME_DEP_PK)) return false;
        Q_SMME_DEP_PK that = (Q_SMME_DEP_PK) o;
