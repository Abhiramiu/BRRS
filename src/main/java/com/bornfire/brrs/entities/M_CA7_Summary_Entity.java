...
@Entity
@Table(name = "BRRS_M_CA7_SUMMARYTABLE")
public class M_CA7_Summary_Entity {
	...
	public M_CA7_Summary_Entity(BigDecimal r12_pre_ifrs_pro, BigDecimal r12_post_ifrs9_pro, BigDecimal r12_trans_amt,
			String r19_product, BigDecimal r19_cap_year1, BigDecimal r19_amt_add_year1, String r20_product,
			BigDecimal r20_cap_year2, BigDecimal r20_amt_add_year2, String r21_product, BigDecimal r21_cap_year3,
			BigDecimal r21_amt_add_year3, String r22_product, BigDecimal r22_cap_year4, BigDecimal r22_amt_add_year4,
			Date report_date, String report_version, String report_frequency, String report_code, String report_desc,
