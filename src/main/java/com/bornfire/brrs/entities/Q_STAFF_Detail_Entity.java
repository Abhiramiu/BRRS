...
public class Q_STAFF_Detail_Entity {
    ...
    @Column(name = "LOCAL", precision = 20, scale = 0)
    private BigDecimal local;

    @Column(name = "EXPARIATES", precision = 20, scale = 0)
    private BigDecimal expatriates;

    @Column(name = "TOTAL", precision = 20, scale = 0)
    private BigDecimal total;

    @Column(name = "ORIGINAL_AMT", precision = 20, scale = 0)
    private BigDecimal original_amt;

    @Column(name = "BALANCE_OUTSTANDING", precision = 20, scale = 0)
    private BigDecimal balance_outstanding;

    @Column(name = "NO_OF_ACS", precision = 20, scale = 0)
    private BigDecimal no_of_acs;
    ...
    public BigDecimal getExpatriates() {
        return expatriates;
    }

    public void setExpatriates(BigDecimal expatriates) {
        this.expatriates = expatriates;
    }
    ...
    public BigDecimal getNo_of_acs() {
        return no_of_acs;
    }

    public void setNo_of_acs(BigDecimal no_of_acs) {
        this.no_of_acs = no_of_acs;
    }
