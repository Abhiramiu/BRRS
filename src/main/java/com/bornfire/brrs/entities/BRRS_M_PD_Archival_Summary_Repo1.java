...
public interface BRRS_M_PD_Archival_Summary_Repo1 extends JpaRepository<M_PD_Archival_Summary_Entity1, Date> {
	 ...
	 @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_M_PD_ARCHIVAL_TABLE_SUMMARY1 order by REPORT_VERSION", nativeQuery = true)
	    ...
	    List<M_PD_Archival_Summary_Entity1> getdatabydateListarchival(Date report_date, String report_version);
}
