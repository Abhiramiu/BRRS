...
public class OFF_BS_ITEMS_PK implements Serializable {

    private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public OFF_BS_ITEMS_PK() {}

    // parameterized constructor
    public OFF_BS_ITEMS_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OFF_BS_ITEMS_PK)) return false;
        OFF_BS_ITEMS_PK that = (OFF_BS_ITEMS_PK) o;
