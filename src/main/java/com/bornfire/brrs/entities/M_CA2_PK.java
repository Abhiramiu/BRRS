...
public class M_CA2_PK implements Serializable {
    ...
    public M_CA2_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_CA2_PK)) return false;
        M_CA2_PK that = (M_CA2_PK) o;
