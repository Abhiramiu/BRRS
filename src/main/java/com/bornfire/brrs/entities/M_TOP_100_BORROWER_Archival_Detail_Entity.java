...
@Entity
@Table(name = "BRRS_M_TOP_100_BORROWER_ARCHIVALTABLE_DETAIL")
public class M_TOP_100_BORROWER_Archival_Detail_Entity {
	...
	public M_TOP_100_BORROWER_Archival_Detail_Entity() {
		super();
