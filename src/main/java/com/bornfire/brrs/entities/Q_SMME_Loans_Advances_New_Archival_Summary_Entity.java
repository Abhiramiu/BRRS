...
@Entity
@Table(name = "BRRS_Q_SMME_LOANS_ADVANCES_NEW_ARCHIVALTABLE_SUMMARY")
public class Q_SMME_Loans_Advances_New_Archival_Summary_Entity {
    ...
    public Q_SMME_Loans_Advances_New_Archival_Summary_Entity() {
        super();
    }
