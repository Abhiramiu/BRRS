...
@Entity
@Table(name = "BRRS_M_INT_RATES_FCA_NEW_ARCHIVALTABLE_SUMMARY")
@IdClass(M_INT_RATES_FCA_NEW_Archival_Summary_PK.class)


public class M_INT_RATES_FCA_NEW_Archival_Summary_Entity {
	...
	public M_INT_RATES_FCA_NEW_Archival_Summary_Entity() {
		super();
