...
public class DTAX_PK implements Serializable {
    ...
    public DTAX_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DTAX_PK)) return false;
        DTAX_PK that = (DTAX_PK) o;
