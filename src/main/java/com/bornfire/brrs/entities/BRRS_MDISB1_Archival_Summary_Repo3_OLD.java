...
@Repository
public interface BRRS_MDISB1_Archival_Summary_Repo3_OLD extends JpaRepository<MDISB1_Archival_Summary_Manual_old, Date> {
    ...
    List<MDISB1_Archival_Summary_Manual_old> getdatabydateListarchival(Date report_date, BigDecimal report_version);
}
