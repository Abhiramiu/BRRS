...
@Entity
@Table(name = "BRRS_Q_LARADV_ARCHIVAL_DETAILTABLE")
public class Q_LARADV_Archival_Detail_Entity {
	
	@Id
	    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "brrs_q_laradv_Archival_Detail_seq_gen")
	    @SequenceGenerator(
	            name = "brrs_q_laradv_Archival_Detail_seq_gen",
	            sequenceName = "BRRS_Q_LARADV_ARCHIVAL_DETAILTABLE_SNO_SEQ",
	            allocationSize = 1
	    )
	    @Column(name = "SNO")
	    private Long sno;
