...
@Entity
@Table(name = "BRRS_REPORT_MAST")
public class RRReportMast {
	...
	public RRReportMast(int srlNo, Date rptStartDate, String rptCode, String rptDescription, String rptType, String detFlg,
