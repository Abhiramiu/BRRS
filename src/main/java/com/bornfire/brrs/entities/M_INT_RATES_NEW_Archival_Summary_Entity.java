...
@Entity
@Table(name = "BRRS_M_INT_RATES_NEW_ARCHIVALTABLE_SUMMARY")


public class M_INT_RATES_NEW_Archival_Summary_Entity {
	...
	public M_INT_RATES_NEW_Archival_Summary_Entity() {
		super();
