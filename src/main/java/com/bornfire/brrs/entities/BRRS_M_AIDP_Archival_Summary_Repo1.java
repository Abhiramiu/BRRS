...
public interface BRRS_M_AIDP_Archival_Summary_Repo1 extends JpaRepository<M_AIDP_Archival_Summary_Entity1, M_AIDP_PK> {
	...
	@Query(value = "select REPORT_DATE, REPORT_VERSION, REPORT_RESUBDATE from BRRS_M_AIDP_ARCHIVALTABLE_SUMMARY1 order by REPORT_VERSION", nativeQuery = true)
	...
	List<M_AIDP_Archival_Summary_Entity1> getdatabydateListarchival(Date date, BigDecimal report_version);
