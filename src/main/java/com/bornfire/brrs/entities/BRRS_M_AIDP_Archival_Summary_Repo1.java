...
@Repository
public interface BRRS_M_AIDP_Archival_Summary_Repo1 extends JpaRepository<M_AIDP_Archival_Summary_Entity1, Date> {
    ...
    List<M_AIDP_Archival_Summary_Entity1> getdatabydateListarchival(Date report_date, String report_version);
}
