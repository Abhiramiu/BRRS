...
@Repository
public interface BRRS_GL_SCH_Archival_Summary_Repo3 extends JpaRepository<GL_SCH_Archival_Summary_Entity3, Date> {

    @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_GL_SCH_ARCHIVALTABLE_SUMMARY3 order by REPORT_VERSION", nativeQuery = true)
