...
public interface BRRS_Common_Disclosure_Archival_Detail_Repo extends JpaRepository<Common_Disclosure_Archival_Detail_Entity, String> {
...
@Query(value = "select * from BRRS_COMMON_DISCLOSURE_ARCHIVALTABLE_DETAIL where REPORT_DATE=?1 AND DATA_ENTRY_VERSION=?2", nativeQuery = true)
	...
	List<Common_Disclosure_Archival_Detail_Entity> GetDataByRowIdAndColumnId(String reportLable,String reportAddlCriteria_1,Date reportdate,String DATA_ENTRY_VERSION);
