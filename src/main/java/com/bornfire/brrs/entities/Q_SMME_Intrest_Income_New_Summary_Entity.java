...
@Entity
@Table(name = "BRRS_Q_SMME_INTREST_INCOME_NEW_SUMMARYTABLE")
public class Q_SMME_Intrest_Income_New_Summary_Entity {
    ...
    public Q_SMME_Intrest_Income_New_Summary_Entity() {
