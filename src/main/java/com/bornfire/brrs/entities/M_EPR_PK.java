...
public class M_EPR_PK implements Serializable {
    ...
    public M_EPR_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_EPR_PK)) return false;
        M_EPR_PK that = (M_EPR_PK) o;
