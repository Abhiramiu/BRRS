...
public interface BRRS_M_SRWA_12H_Archival_Summary_Repo
    extends JpaRepository<M_SRWA_12H_Archival_Summary_Entity, M_SRWA_12H_PK> {
    ...
    @Query("SELECT MAX(e.reportVersion) FROM M_SRWA_12H_Archival_Summary_Entity e WHERE e.reportDate = :date")
