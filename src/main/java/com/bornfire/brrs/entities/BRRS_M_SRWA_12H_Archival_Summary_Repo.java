...
//   @Query(value = "SELECT * FROM BRRS_M_SRWA_12H_ARCHIVALTABLE_SUMMARY "
//       + "WHERE REPORT_DATE = ?1 AND REPORT_VERSION = ?2", nativeQuery = true)
//   List<M_SRWA_12H_Archival_Summary_Entity> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);
...
//   Optional<M_SRWA_12H_Summary_Entity> findByReportDateAndReportVersion(Date reportDate, BigDecimal reportVersion);

//   // Current Report Version Only Shown
//   @Query(value = "SELECT * FROM BRRS_M_SRWA_12H_ARCHIVALTABLE_SUMMARY WHERE REPORT_VERSION IS NOT NULL ORDER BY REPORT_VERSION ASC", nativeQuery = true)
...
//   List<M_SRWA_12H_Archival_Summary_Entity> getdatabydateListWithVersionAll();
    ...
    List<M_SRWA_12H_Archival_Summary_Entity> getdatabydateListarchival(Date report_date, BigDecimal report_version);
