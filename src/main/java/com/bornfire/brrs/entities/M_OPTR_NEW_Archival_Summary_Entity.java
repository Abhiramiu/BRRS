...
@Entity
@Table(name = "BRRS_M_OPTR_NEW_ARCHIVALTABLE_SUMMARY")
@IdClass(M_OPTR_NEW_Archival_Summary_PK.class)

public class M_OPTR_NEW_Archival_Summary_Entity {
...
public void setR9_TOTAL(BigDecimal r9_TOTAL) {
	...
	public M_OPTR_NEW_Archival_Summary_Entity() {
        super();
    }
