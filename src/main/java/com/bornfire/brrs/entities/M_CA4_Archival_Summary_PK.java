...
public class M_CA4_Archival_Summary_PK implements Serializable {

    private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public M_CA4_Archival_Summary_PK() {}

    // parameterized constructor
    public M_CA4_Archival_Summary_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_CA4_Archival_Summary_PK)) return false;
        M_CA4_Archival_Summary_PK that = (M_CA4_Archival_Summary_PK) o;
