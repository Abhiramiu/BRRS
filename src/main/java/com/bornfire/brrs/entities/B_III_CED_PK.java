...
public class B_III_CED_PK implements Serializable {
    ...
    public B_III_CED_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof B_III_CED_PK)) return false;
        B_III_CED_PK that = (B_III_CED_PK) o;
