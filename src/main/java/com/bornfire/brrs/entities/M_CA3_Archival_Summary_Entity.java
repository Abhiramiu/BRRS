...
@Entity
@Table(name="BRRS_M_CA3_ARCHIVALTABLE_SUMMARY")
@IdClass(M_CA3_Archival_Summary_PK.class)


public
class M_CA3_Archival_Summary_Entity {
	...
	public M_CA3_Archival_Summary_Entity() {
		super();
