...
//	List<MDISB4_Detail_Entity_OLD> GetDataByRowIdAndColumnId(String reportLabel, String reportAddlCriteria_1, Date reportdate);
//
//	
...
//	List<MDISB4_Detail_Entity_OLD> getdatabydateList(Date reportdate,int startpage,int endpage);
//	
...
//	MDISB4_Detail_Entity_OLD findByAcctNumber(@Param("acctNumber") String acctNumber);
	
	
	@Query(value = "SELECT * FROM BRRS_MDISB4_DETAILTABLE WHERE REPORT_DATE = ?1", nativeQuery = true)
	List<MDISB4_Detail_Entity_OLD> getdatabydateList(Date reportdate);

	@Query(value = "SELECT * FROM BRRS_MDISB4_DETAILTABLE WHERE REPORT_LABEL = ?1 AND REPORT_ADDL_CRITERIA_1 = ?2 AND REPORT_DATE = ?3", nativeQuery = true)
	List<MDISB4_Detail_Entity_OLD> GetDataByRowIdAndColumnId(
			String reportLabel,
			String reportAddlCriteria_1,
			Date reportdate);

	@Query(value = "SELECT * FROM BRRS_MDISB4_DETAILTABLE WHERE REPORT_DATE = ?1 OFFSET ?2 ROWS FETCH NEXT ?3 ROWS ONLY", nativeQuery = true)
	List<MDISB4_Detail_Entity_OLD> getdatabydateList(
			Date reportdate,
			int startpage,
			int endpage);
	...
	@Query(value = "SELECT * FROM BRRS_MDISB4_DETAILTABLE WHERE ACCT_NUMBER = :acctNumber", nativeQuery = true)
	MDISB4_Detail_Entity_OLD findByAcctNumber(@Param("acctNumber") String acctNumber);
