...
@Entity
@Table(name = "BRRS_Q_SMME_INTREST_INCOME_NEW_ARCHIVALTABLE_DETAIL")
public class Q_SMME_Intrest_Income_New_Archival_Detail_Entity {
...
public void setMonthlyInterest(BigDecimal monthlyInterest) {
    ...
    public Q_SMME_Intrest_Income_New_Archival_Detail_Entity() {
        super();
    }
