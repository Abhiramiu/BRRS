...
@Repository
public interface BRRS_Q_RLFA1_Archival_Summary_Repo
		extends JpaRepository<Q_RLFA1_Archival_Summary_Entity, Q_RLFA1_Archival_Summary_PK> {
	...
	@Query(value = "SELECT * FROM BRRS_Q_RLFA1_ARCHIVALTABLE_SUMMARY "
	...
	@Query(value = "SELECT * FROM BRRS_Q_RLFA1_ARCHIVALTABLE_SUMMARY WHERE REPORT_DATE = ?1 AND REPORT_VERSION = ?2", nativeQuery = true)
	Optional<Q_RLFA1_Archival_Summary_Entity> findByReport_dateAndReport_version(Date report_date,
