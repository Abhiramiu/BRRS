...
@Entity
@Table(name = "BRRS_M_CA5_RESUB_SUMMARYTABLE2")
@IdClass(M_CA5_Archival_Summary2_PK.class)
public class M_CA5_RESUB_Summary_Entity2 {
	...
	public M_CA5_RESUB_Summary_Entity2() {
		super();
