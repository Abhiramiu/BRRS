...
public class M_SRWA_12A_PK implements Serializable {

    private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public M_SRWA_12A_PK() {}

    // parameterized constructor
    public M_SRWA_12A_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_SRWA_12A_PK)) return false;
        M_SRWA_12A_PK that = (M_SRWA_12A_PK) o;
