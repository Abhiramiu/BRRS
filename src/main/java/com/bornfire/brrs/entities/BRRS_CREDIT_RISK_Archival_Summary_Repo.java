...
@Repository
public interface BRRS_CREDIT_RISK_Archival_Summary_Repo extends JpaRepository<CREDIT_RISK_Archival_Summary_Entity, Date> {

    @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_CREDIT_RISK_ARCHIVALTABLE_SUMMARY order by REPORT_VERSION", nativeQuery = true)
