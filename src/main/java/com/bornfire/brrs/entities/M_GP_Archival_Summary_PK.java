...
public class M_GP_Archival_Summary_PK implements Serializable {

    private Date reportDate;
    private BigDecimal reportVersion;

    // default constructor
    public M_GP_Archival_Summary_PK() {}

    // parameterized constructor
    public M_GP_Archival_Summary_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_GP_Archival_Summary_PK)) return false;
        M_GP_Archival_Summary_PK that = (M_GP_Archival_Summary_PK) o;
