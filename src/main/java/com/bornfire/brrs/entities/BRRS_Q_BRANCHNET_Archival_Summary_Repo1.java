...
public interface BRRS_Q_BRANCHNET_Archival_Summary_Repo1
    ...
    List<Q_BRANCHNET_Archival_Summary_Entity1> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);
    ...
    Optional<Q_BRANCHNET_Summary_Entity1> findByReportDateAndReportVersion(Date reportDate, BigDecimal reportVersion);
