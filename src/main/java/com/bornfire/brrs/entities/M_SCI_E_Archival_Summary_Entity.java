...
@Entity
@Table(name = "BRRS_M_SCI_E_ARCHIVALTABLE_SUMMARY")
@IdClass(M_SCI_E_PK.class)

public class M_SCI_E_Archival_Summary_Entity {
		...
		public M_SCI_E_Archival_Summary_Entity() {
			super();
