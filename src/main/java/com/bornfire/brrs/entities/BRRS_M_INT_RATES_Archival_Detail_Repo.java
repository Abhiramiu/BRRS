...
@Repository
public interface BRRS_M_INT_RATES_Archival_Detail_Repo extends JpaRepository<M_INT_RATES_FCA_Archival_Detail_Entity,Date> {
	 ...
	 @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_M_INT_RATES_ARCHIVALTABLE_DETAIL order by REPORT_VERSION", nativeQuery = true)
	    List<Object> getM_INT_RATES_archival();
