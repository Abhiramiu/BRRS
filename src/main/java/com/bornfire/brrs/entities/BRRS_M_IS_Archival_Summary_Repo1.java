...
// public interface BRRS_M_IS_Archival_Summary_Repo1 extends JpaRepository<M_IS_Archival_Summary_Entity1, Date> {

//     @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_M_IS_ARCHIVALTABLE_SUMMARY1 order by REPORT_VERSION", nativeQuery = true)
...
//     List<M_IS_Archival_Summary_Entity1> getdatabydateListarchival(Date report_date, String report_version);
// }
...
public interface BRRS_M_IS_Archival_Summary_Repo1 
    ...
    @Query(value = "SELECT * FROM BRRS_M_IS_ARCHIVALTABLE_SUMMARY1 WHERE REPORT_DATE = ?1 AND REPORT_VERSION = ?2", nativeQuery = true)
    List<M_IS_Archival_Summary_Entity1> getdatabydateListarchival(Date reportDate, String reportVersion);
