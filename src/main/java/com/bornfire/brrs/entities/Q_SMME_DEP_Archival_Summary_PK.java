...
public class Q_SMME_DEP_Archival_Summary_PK implements Serializable {

    private Date report_date;
    private String report_version;

    // default constructor
    public Q_SMME_DEP_Archival_Summary_PK() {}

    // parameterized constructor
    public Q_SMME_DEP_Archival_Summary_PK(Date report_date, String report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Q_SMME_DEP_Archival_Summary_PK)) return false;
        Q_SMME_DEP_Archival_Summary_PK that = (Q_SMME_DEP_Archival_Summary_PK) o;
