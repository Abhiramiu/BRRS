...
public interface BRRS_M_DEP4_Archival_Summary_Repo3  extends JpaRepository<M_DEP4_Archival_Summary_Entity3, M_DEP4_PK> {
    ...
    List<M_DEP4_Archival_Summary_Entity3> getdatabydateListarchival(Date reportDate, BigDecimal reportVersion);
    ...
    @Query(value = "SELECT * FROM BRRS_M_DEP4_ARCHIVALTABLE_SUMMARY3 " +
           ...
           nativeQuery = true)
    List<M_DEP4_Archival_Summary_Entity3> 
