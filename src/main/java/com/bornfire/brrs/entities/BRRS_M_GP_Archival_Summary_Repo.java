...
@Repository
public interface BRRS_M_GP_Archival_Summary_Repo extends JpaRepository<M_GP_Archival_Summary_Entity, Date> {
	   @Query(value = "select REPORT_DATE, REPORT_VERSION from BRRS_M_GP_ARCHIVALTABLE_SUMMARY order by REPORT_VERSION", nativeQuery = true)
	    ...
	    List<M_GP_Archival_Summary_Entity> getdatabydateListarchival(Date REPORT_DATE, String REPORT_VERSION);
