...
@Repository
public interface BRRS_M_AIDP_Archival_Detail_Repo2 extends JpaRepository<M_AIDP_Archival_Detail_Entity2, M_AIDP_PK> {
	...
	static List<M_AIDP_Archival_Detail_Entity2> getdatabydateList(Date rpt_code) {
