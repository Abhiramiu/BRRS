...
@Entity
@Table(name = "BRRS_M_TOP_100_BORROWER_MANUAL_ARCHIVALTABLE_SUMMARY2")

public class M_TOP_100_BORROWER_Manual_Archival_Summary_Entity2 {
	...
	public M_TOP_100_BORROWER_Manual_Archival_Summary_Entity2() {
		super();
