...
public interface BRRS_BDISB1_Detail_Repo extends JpaRepository<BDISB1_Detail_Entity,String> {
    ...
    @Query(value = "select * from BRRS_BDISB1_DETAILTABLE where REPORT_DATE = ?1", nativeQuery = true)
    List<BDISB1_Detail_Entity> getdatabydateList(Date reportdate);
    ...
    List<BDISB1_Detail_Entity> getdatabydateList(Date reportdate,int startpage,int endpage);
