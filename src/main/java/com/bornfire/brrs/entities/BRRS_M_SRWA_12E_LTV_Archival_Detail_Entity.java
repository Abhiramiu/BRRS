...
@Entity
@Table(name = "BRRS_M_SRWA_12E_ARCHIVAL_TABLE_DETAIL")
public class BRRS_M_SRWA_12E_LTV_Archival_Detail_Entity {
    ...
    public BRRS_M_SRWA_12E_LTV_Archival_Detail_Entity(String cUST_ID, String aCCT_NUMBER, String aCCT_NAME, String dATA_TYPE,
    ...
    public BRRS_M_SRWA_12E_LTV_Archival_Detail_Entity() {
        super();
    }
