...
public interface BRRS_M_CALOC_Archival_Summary_Repo2 extends JpaRepository<M_CALOC_Archival_Summary_Entity2 , Date>{
	...
	List<M_CALOC_Archival_Summary_Entity2> getdatabydateListarchival(Date report_date, String report_version);
