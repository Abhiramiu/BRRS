...
public class M_LIQGAP_PK implements Serializable {
    ...
    public M_LIQGAP_PK(Date reportDate, BigDecimal reportVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_LIQGAP_PK)) return false;
        M_LIQGAP_PK that = (M_LIQGAP_PK) o;
