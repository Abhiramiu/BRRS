...
public class M_SECL_Resub_Detail_PK implements Serializable {

	private Date report_date;
    private BigDecimal report_version;

    // default constructor
    public M_SECL_Resub_Detail_PK() {}

    // parameterized constructor
    public M_SECL_Resub_Detail_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_SECL_Resub_Detail_PK)) return false;
        M_SECL_Resub_Detail_PK that = (M_SECL_Resub_Detail_PK) o;
