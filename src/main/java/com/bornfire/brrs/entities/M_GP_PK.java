...
public class M_GP_PK implements Serializable {
    ...
    public M_GP_PK(Date report_date, BigDecimal report_version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof M_GP_PK)) return false;
        M_GP_PK that = (M_GP_PK) o;
