...
public interface BRRSValidationsRepo extends JpaRepository<BRRSValidations, String> {
	...
	// Srl_no7
	// M_LIQ summarytable
	@Query(value = "Select count(*) from BRRS_M_LIQ_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no9
	// M_IS summarytable
	@Query(value = "Select count(*) from BRRS_M_IS_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no14
	// M_CA5 summarytable
	@Query(value = "Select count(*) from BRRS_M_CA5_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	Integer getCheckSrlNo14(String report_date);
	
	// Srl_no15
	// M_CA6 summarytable
	@Query(value = "Select count(*) from BRRS_M_CA6_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	@Query(value = "Select count(*) from BRRS_M_SRWA_12A_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	Integer getCheckSrlNo17(String report_date);
	
	// Srl_no18
	// M_SRWA_12B summarytable
	@Query(value = "Select count(*) from BRRS_M_SRWA_12B_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	@Query(value = "Select count(*) from BRRS_M_GALOR_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	Integer getCheckSrlNo35(String report_date);
	
	// Srl_no36
	// M_CALOC summarytable
	@Query(value = "Select count(*) from BRRS_M_CALOC_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no39
	// M_LA3 summarytable
	@Query(value = "Select count(*) from BRRS_M_LA3_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	Integer getCheckSrlNo39(String report_date);
	
	// Srl_no40
	// M_LA4 summarytable
	@Query(value = "Select count(*) from BRRS_M_LA4_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no43
	// M_PD summarytable
	@Query(value = "Select count(*) from BRRS_M_PD_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	@Query(value = "Select count(*) from BRRS_M_LIQGAP_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	Integer getCheckSrlNo48(String report_date);
	
	
	// Srl_no49
	// M_NOSVOS summarytable
	@Query(value = "Select count(*) from BRRS_M_NOSVOS_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	Integer getCheckSrlNo49(String report_date);
	
	
	// Srl_no50
	// AIDP summarytable
	@Query(value = "Select count(*) from BRRS_M_AIDP_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no54
	// DEP4 summarytable
	@Query(value = "Select count(*) from BRRS_M_DEP4_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no61
	// RPD summarytable
	@Query(value = "Select count(*) from BRRS_M_RPD_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	// Srl_no63
	// SEC summarytable
	@Query(value = "Select count(*) from BRRS_M_SEC_SUMMARYTABLE where REPORT_DATE=?1 ", nativeQuery = true)
	...
	@Query(value = "Select count(*) from BRRS_M_LARADV_SUMMARYTABLE1 where REPORT_DATE=?1 ", nativeQuery = true)
